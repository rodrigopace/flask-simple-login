...
class AIServiceSpeechClient(object):
    ...
    def cancel_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/cancel_transcription_job.py.html>`__ to see an example of how to use cancel_transcription_job API.
        """
    ...
    def cancel_transcription_task(self, transcription_job_id, transcription_task_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/cancel_transcription_task.py.html>`__ to see an example of how to use cancel_transcription_task API.
        """
    ...
    def change_transcription_job_compartment(self, transcription_job_id, change_transcription_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/change_transcription_job_compartment.py.html>`__ to see an example of how to use change_transcription_job_compartment API.
        """
    ...
    def create_transcription_job(self, create_transcription_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/create_transcription_job.py.html>`__ to see an example of how to use create_transcription_job API.
        """
    ...
    def get_transcription_job(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/get_transcription_job.py.html>`__ to see an example of how to use get_transcription_job API.
        """
    ...
    def get_transcription_task(self, transcription_job_id, transcription_task_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/get_transcription_task.py.html>`__ to see an example of how to use get_transcription_task API.
        """
    ...
    def list_transcription_jobs(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/list_transcription_jobs.py.html>`__ to see an example of how to use list_transcription_jobs API.
        """
        resource_path = "/transcriptionJobs"
        method = "GET"
    ...
    def list_transcription_tasks(self, transcription_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/list_transcription_tasks.py.html>`__ to see an example of how to use list_transcription_tasks API.
        """
    ...
    def update_transcription_job(self, transcription_job_id, update_transcription_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aispeech/update_transcription_job.py.html>`__ to see an example of how to use update_transcription_job API.
        """
        resource_path = "/transcriptionJobs/{transcriptionJobId}"
        method = "PUT"

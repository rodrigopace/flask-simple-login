...
class DataplaneClient(object):
    ...
    def generate_scoped_access_token(self, generate_scoped_access_token_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/identitydataplane/generate_scoped_access_token.py.html>`__ to see an example of how to use generate_scoped_access_token API.
        """

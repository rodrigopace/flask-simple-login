...
class InvoiceServiceClient(object):
    ...
    def download_pdf_content(self, osp_home_region, compartment_id, internal_invoice_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ospgateway/download_pdf_content.py.html>`__ to see an example of how to use download_pdf_content API.
        """
    ...
    def get_invoice(self, osp_home_region, compartment_id, internal_invoice_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ospgateway/get_invoice.py.html>`__ to see an example of how to use get_invoice API.
        """
    ...
    def list_invoice_lines(self, osp_home_region, compartment_id, internal_invoice_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ospgateway/list_invoice_lines.py.html>`__ to see an example of how to use list_invoice_lines API.
        """
    ...
    def list_invoices(self, osp_home_region, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ospgateway/list_invoices.py.html>`__ to see an example of how to use list_invoices API.
        """
    ...
    def pay_invoice(self, osp_home_region, internal_invoice_id, compartment_id, pay_invoice_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ospgateway/pay_invoice.py.html>`__ to see an example of how to use pay_invoice API.
        """

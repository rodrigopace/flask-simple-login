...
class CertificatesClient(object):
    ...
    def get_ca_bundle(self, ca_bundle_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/certificates/get_ca_bundle.py.html>`__ to see an example of how to use get_ca_bundle API.
        """
    ...
    def get_certificate_authority_bundle(self, certificate_authority_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/certificates/get_certificate_authority_bundle.py.html>`__ to see an example of how to use get_certificate_authority_bundle API.
        """
    ...
    def get_certificate_bundle(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/certificates/get_certificate_bundle.py.html>`__ to see an example of how to use get_certificate_bundle API.
        """
    ...
    def list_certificate_authority_bundle_versions(self, certificate_authority_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/certificates/list_certificate_authority_bundle_versions.py.html>`__ to see an example of how to use list_certificate_authority_bundle_versions API.
        """
    ...
    def list_certificate_bundle_versions(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/certificates/list_certificate_bundle_versions.py.html>`__ to see an example of how to use list_certificate_bundle_versions API.
        """

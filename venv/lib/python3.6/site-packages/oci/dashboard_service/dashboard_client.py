...
class DashboardClient(object):
    ...
    **Important:** Resources for the Dashboards service are created in the tenacy's home region.
    ...
    def change_dashboard_group(self, dashboard_id, change_dashboard_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/change_dashboard_group.py.html>`__ to see an example of how to use change_dashboard_group API.
        """
    ...
    def create_dashboard(self, create_dashboard_details, **kwargs):
        ...
        **Caution:** Resources for the Dashboard service are created in the tenacy's home region.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/create_dashboard.py.html>`__ to see an example of how to use create_dashboard API.
        """
    ...
    def delete_dashboard(self, dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/delete_dashboard.py.html>`__ to see an example of how to use delete_dashboard API.
        """
    ...
    def get_dashboard(self, dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/get_dashboard.py.html>`__ to see an example of how to use get_dashboard API.
        """
        resource_path = "/dashboards/{dashboardId}"
        method = "GET"
    ...
    def list_dashboards(self, dashboard_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/list_dashboards.py.html>`__ to see an example of how to use list_dashboards API.
        """
        resource_path = "/dashboards"
        method = "GET"
    ...
    def update_dashboard(self, dashboard_id, update_dashboard_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/update_dashboard.py.html>`__ to see an example of how to use update_dashboard API.
        """
        resource_path = "/dashboards/{dashboardId}"
        method = "PUT"

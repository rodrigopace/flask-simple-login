...
class DashboardGroupClient(object):
    ...
    **Important:** Resources for the Dashboards service are created in the tenacy's home region.
    ...
    def change_dashboard_group_compartment(self, dashboard_group_id, change_dashboard_group_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/change_dashboard_group_compartment.py.html>`__ to see an example of how to use change_dashboard_group_compartment API.
        """
    ...
    def create_dashboard_group(self, create_dashboard_group_details, **kwargs):
        ...
        **Caution:** Resources for the Dashboard service are created in the tenacy's home region.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/create_dashboard_group.py.html>`__ to see an example of how to use create_dashboard_group API.
        """
    ...
    def delete_dashboard_group(self, dashboard_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/delete_dashboard_group.py.html>`__ to see an example of how to use delete_dashboard_group API.
        """
    ...
    def get_dashboard_group(self, dashboard_group_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/get_dashboard_group.py.html>`__ to see an example of how to use get_dashboard_group API.
        """
        resource_path = "/dashboardGroups/{dashboardGroupId}"
        method = "GET"
    ...
    def list_dashboard_groups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/list_dashboard_groups.py.html>`__ to see an example of how to use list_dashboard_groups API.
        """
        resource_path = "/dashboardGroups"
        method = "GET"
    ...
    def update_dashboard_group(self, dashboard_group_id, update_dashboard_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dashboardservice/update_dashboard_group.py.html>`__ to see an example of how to use update_dashboard_group API.
        """
        resource_path = "/dashboardGroups/{dashboardGroupId}"
        method = "PUT"

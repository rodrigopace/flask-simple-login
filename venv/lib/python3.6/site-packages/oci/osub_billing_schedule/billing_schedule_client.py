...
class BillingScheduleClient(object):
    ...
    def list_billing_schedules(self, compartment_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osubbillingschedule/list_billing_schedules.py.html>`__ to see an example of how to use list_billing_schedules API.
        """

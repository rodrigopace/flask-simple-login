...
class PluginconfigClient(object):
    ...
    def list_instanceagent_available_plugins(self, compartment_id, os_name, os_version, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/computeinstanceagent/list_instanceagent_available_plugins.py.html>`__ to see an example of how to use list_instanceagent_available_plugins API.
        """

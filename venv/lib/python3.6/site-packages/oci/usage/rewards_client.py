...
class RewardsClient(object):
    ...
    def create_redeemable_user(self, create_redeemable_user_details, tenancy_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/usage/create_redeemable_user.py.html>`__ to see an example of how to use create_redeemable_user API.
        """
    ...
    def delete_redeemable_user(self, email_id, tenancy_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/usage/delete_redeemable_user.py.html>`__ to see an example of how to use delete_redeemable_user API.
        """
        resource_path = "/subscriptions/{subscriptionId}/redeemableUsers"
        method = "DELETE"
    ...
    def list_products(self, tenancy_id, subscription_id, usage_period_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/usage/list_products.py.html>`__ to see an example of how to use list_products API.
        """
    ...
    def list_redeemable_users(self, tenancy_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/usage/list_redeemable_users.py.html>`__ to see an example of how to use list_redeemable_users API.
        """
        resource_path = "/subscriptions/{subscriptionId}/redeemableUsers"
        method = "GET"
    ...
    def list_redemptions(self, tenancy_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/usage/list_redemptions.py.html>`__ to see an example of how to use list_redemptions API.
        """
    ...
    def list_rewards(self, tenancy_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/usage/list_rewards.py.html>`__ to see an example of how to use list_rewards API.
        """

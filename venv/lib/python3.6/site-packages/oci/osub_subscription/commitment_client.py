...
class CommitmentClient(object):
    ...
    def get_commitment(self, commitment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osubsubscription/get_commitment.py.html>`__ to see an example of how to use get_commitment API.
        """
    ...
    def list_commitments(self, subscribed_service_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osubsubscription/list_commitments.py.html>`__ to see an example of how to use list_commitments API.
        """

...
class QuotasClient(object):
    ...
    def add_quota_lock(self, quota_id, add_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/add_quota_lock.py.html>`__ to see an example of how to use add_quota_lock API.
        """
    ...
    def create_quota(self, create_quota_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/create_quota.py.html>`__ to see an example of how to use create_quota API.
        """
    ...
    def delete_quota(self, quota_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/delete_quota.py.html>`__ to see an example of how to use delete_quota API.
        """
    ...
    def get_quota(self, quota_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/get_quota.py.html>`__ to see an example of how to use get_quota API.
        """
        resource_path = "/20181025/quotas/{quotaId}"
        method = "GET"
    ...
    def list_quotas(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/list_quotas.py.html>`__ to see an example of how to use list_quotas API.
        """
        resource_path = "/20181025/quotas"
        method = "GET"
    ...
    def remove_quota_lock(self, quota_id, remove_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/remove_quota_lock.py.html>`__ to see an example of how to use remove_quota_lock API.
        """
    ...
    def update_quota(self, quota_id, update_quota_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/update_quota.py.html>`__ to see an example of how to use update_quota API.
        """
        resource_path = "/20181025/quotas/{quotaId}"
        method = "PUT"

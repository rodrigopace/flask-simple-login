...
class LimitsClient(object):
    ...
    def get_resource_availability(self, service_name, limit_name, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/get_resource_availability.py.html>`__ to see an example of how to use get_resource_availability API.
        """
    ...
    def list_limit_definitions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/list_limit_definitions.py.html>`__ to see an example of how to use list_limit_definitions API.
        """
    ...
    def list_limit_values(self, compartment_id, service_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/list_limit_values.py.html>`__ to see an example of how to use list_limit_values API.
        """
    ...
    def list_services(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/limits/list_services.py.html>`__ to see an example of how to use list_services API.
        """

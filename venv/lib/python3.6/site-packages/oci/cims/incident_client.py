...
class IncidentClient(object):
    ...
    def create_incident(self, create_incident_details, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/create_incident.py.html>`__ to see an example of how to use create_incident API.
        """
    ...
    def get_incident(self, incident_key, csi, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/get_incident.py.html>`__ to see an example of how to use get_incident API.
        """
    ...
    def get_status(self, source, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/get_status.py.html>`__ to see an example of how to use get_status API.
        """
    ...
    def list_incident_resource_types(self, problem_type, compartment_id, csi, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/list_incident_resource_types.py.html>`__ to see an example of how to use list_incident_resource_types API.
        """
    ...
    def list_incidents(self, csi, compartment_id, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/list_incidents.py.html>`__ to see an example of how to use list_incidents API.
        """
        resource_path = "/v2/incidents"
        method = "GET"
    ...
    def update_incident(self, incident_key, csi, update_incident_details, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/update_incident.py.html>`__ to see an example of how to use update_incident API.
        """
        resource_path = "/v2/incidents/{incidentKey}"
        method = "PUT"
    ...
    def validate_user(self, csi, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/validate_user.py.html>`__ to see an example of how to use validate_user API.
        """

...
class UserClient(object):
    ...
    def create_user(self, create_user_details, ocid, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/cims/create_user.py.html>`__ to see an example of how to use create_user API.
        """

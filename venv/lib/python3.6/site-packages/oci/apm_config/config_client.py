...
class ConfigClient(object):
    ...
    def create_config(self, apm_domain_id, create_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/create_config.py.html>`__ to see an example of how to use create_config API.
        """
    ...
    def delete_config(self, apm_domain_id, config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/delete_config.py.html>`__ to see an example of how to use delete_config API.
        """
    ...
    def get_config(self, apm_domain_id, config_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/get_config.py.html>`__ to see an example of how to use get_config API.
        """
        resource_path = "/configs/{configId}"
        method = "GET"
    ...
    def list_configs(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/list_configs.py.html>`__ to see an example of how to use list_configs API.
        """
        resource_path = "/configs"
        method = "GET"
    ...
    def retrieve_namespace_metrics(self, apm_domain_id, retrieve_namespace_metrics_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/retrieve_namespace_metrics.py.html>`__ to see an example of how to use retrieve_namespace_metrics API.
        """
    ...
    def retrieve_namespaces(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/retrieve_namespaces.py.html>`__ to see an example of how to use retrieve_namespaces API.
        """
    ...
    def update_config(self, apm_domain_id, config_id, update_config_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/update_config.py.html>`__ to see an example of how to use update_config API.
        """
        resource_path = "/configs/{configId}"
        method = "PUT"
    ...
    def validate_span_filter_pattern(self, apm_domain_id, validate_span_filter_pattern_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmconfig/validate_span_filter_pattern.py.html>`__ to see an example of how to use validate_span_filter_pattern API.
        """

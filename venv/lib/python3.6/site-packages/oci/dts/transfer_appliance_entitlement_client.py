...
class TransferApplianceEntitlementClient(object):
    ...
    def create_transfer_appliance_entitlement(self, create_transfer_appliance_entitlement_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_transfer_appliance_entitlement.py.html>`__ to see an example of how to use create_transfer_appliance_entitlement API.
        """
    ...
    def get_transfer_appliance_entitlement(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_appliance_entitlement.py.html>`__ to see an example of how to use get_transfer_appliance_entitlement API.
        """
    ...
    def list_transfer_appliance_entitlement(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/list_transfer_appliance_entitlement.py.html>`__ to see an example of how to use list_transfer_appliance_entitlement API.
        """
        resource_path = "/transferApplianceEntitlement"
        method = "GET"

...
class TransferDeviceClient(object):
    ...
    def create_transfer_device(self, id, create_transfer_device_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_transfer_device.py.html>`__ to see an example of how to use create_transfer_device API.
        """
    ...
    def delete_transfer_device(self, id, transfer_device_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/delete_transfer_device.py.html>`__ to see an example of how to use delete_transfer_device API.
        """
    ...
    def get_transfer_device(self, id, transfer_device_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_device.py.html>`__ to see an example of how to use get_transfer_device API.
        """
        resource_path = "/transferJobs/{id}/transferDevices/{transferDeviceLabel}"
        method = "GET"
    ...
    def list_transfer_devices(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/list_transfer_devices.py.html>`__ to see an example of how to use list_transfer_devices API.
        """
        resource_path = "/transferJobs/{id}/transferDevices"
        method = "GET"
    ...
    def update_transfer_device(self, id, transfer_device_label, update_transfer_device_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/update_transfer_device.py.html>`__ to see an example of how to use update_transfer_device API.
        """
        resource_path = "/transferJobs/{id}/transferDevices/{transferDeviceLabel}"
        method = "PUT"

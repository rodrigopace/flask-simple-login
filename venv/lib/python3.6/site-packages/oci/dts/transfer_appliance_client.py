...
class TransferApplianceClient(object):
    ...
    def create_transfer_appliance(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_transfer_appliance.py.html>`__ to see an example of how to use create_transfer_appliance API.
        """
    ...
    def create_transfer_appliance_admin_credentials(self, id, transfer_appliance_label, admin_public_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_transfer_appliance_admin_credentials.py.html>`__ to see an example of how to use create_transfer_appliance_admin_credentials API.
        """
    ...
    def delete_transfer_appliance(self, id, transfer_appliance_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/delete_transfer_appliance.py.html>`__ to see an example of how to use delete_transfer_appliance API.
        """
    ...
    def get_transfer_appliance(self, id, transfer_appliance_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_appliance.py.html>`__ to see an example of how to use get_transfer_appliance API.
        """
        resource_path = "/transferJobs/{id}/transferAppliances/{transferApplianceLabel}"
        method = "GET"
    ...
    def get_transfer_appliance_certificate_authority_certificate(self, id, transfer_appliance_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_appliance_certificate_authority_certificate.py.html>`__ to see an example of how to use get_transfer_appliance_certificate_authority_certificate API.
        """
    ...
    def get_transfer_appliance_encryption_passphrase(self, id, transfer_appliance_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_appliance_encryption_passphrase.py.html>`__ to see an example of how to use get_transfer_appliance_encryption_passphrase API.
        """
    ...
    def list_transfer_appliances(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/list_transfer_appliances.py.html>`__ to see an example of how to use list_transfer_appliances API.
        """
        resource_path = "/transferJobs/{id}/transferAppliances"
        method = "GET"
    ...
    def update_transfer_appliance(self, id, transfer_appliance_label, update_transfer_appliance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/update_transfer_appliance.py.html>`__ to see an example of how to use update_transfer_appliance API.
        """
        resource_path = "/transferJobs/{id}/transferAppliances/{transferApplianceLabel}"
        method = "PUT"

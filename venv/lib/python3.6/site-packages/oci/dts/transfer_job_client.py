...
class TransferJobClient(object):
    ...
    def change_transfer_job_compartment(self, transfer_job_id, change_transfer_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/change_transfer_job_compartment.py.html>`__ to see an example of how to use change_transfer_job_compartment API.
        """
    ...
    def create_transfer_job(self, create_transfer_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_transfer_job.py.html>`__ to see an example of how to use create_transfer_job API.
        """
    ...
    def delete_transfer_job(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/delete_transfer_job.py.html>`__ to see an example of how to use delete_transfer_job API.
        """
    ...
    def get_transfer_job(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_job.py.html>`__ to see an example of how to use get_transfer_job API.
        """
        resource_path = "/transferJobs/{id}"
        method = "GET"
    ...
    def list_transfer_jobs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/list_transfer_jobs.py.html>`__ to see an example of how to use list_transfer_jobs API.
        """
        resource_path = "/transferJobs"
        method = "GET"
    ...
    def update_transfer_job(self, id, update_transfer_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/update_transfer_job.py.html>`__ to see an example of how to use update_transfer_job API.
        """
        resource_path = "/transferJobs/{id}"
        method = "PUT"

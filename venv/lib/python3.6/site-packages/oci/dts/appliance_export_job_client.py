...
class ApplianceExportJobClient(object):
    ...
    def change_appliance_export_job_compartment(self, appliance_export_job_id, change_appliance_export_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/change_appliance_export_job_compartment.py.html>`__ to see an example of how to use change_appliance_export_job_compartment API.
        """
    ...
    def create_appliance_export_job(self, create_appliance_export_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_appliance_export_job.py.html>`__ to see an example of how to use create_appliance_export_job API.
        """
    ...
    def delete_appliance_export_job(self, appliance_export_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/delete_appliance_export_job.py.html>`__ to see an example of how to use delete_appliance_export_job API.
        """
    ...
    def get_appliance_export_job(self, appliance_export_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_appliance_export_job.py.html>`__ to see an example of how to use get_appliance_export_job API.
        """
        resource_path = "/applianceExportJobs/{applianceExportJobId}"
        method = "GET"
    ...
    def list_appliance_export_jobs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/list_appliance_export_jobs.py.html>`__ to see an example of how to use list_appliance_export_jobs API.
        """
        resource_path = "/applianceExportJobs"
        method = "GET"
    ...
    def update_appliance_export_job(self, appliance_export_job_id, update_appliance_export_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/update_appliance_export_job.py.html>`__ to see an example of how to use update_appliance_export_job API.
        """
        resource_path = "/applianceExportJobs/{applianceExportJobId}"
        method = "PUT"

...
class TransferPackageClient(object):
    ...
    def attach_devices_to_transfer_package(self, id, transfer_package_label, attach_devices_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/attach_devices_to_transfer_package.py.html>`__ to see an example of how to use attach_devices_to_transfer_package API.
        """
    ...
    def create_transfer_package(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/create_transfer_package.py.html>`__ to see an example of how to use create_transfer_package API.
        """
    ...
    def delete_transfer_package(self, id, transfer_package_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/delete_transfer_package.py.html>`__ to see an example of how to use delete_transfer_package API.
        """
    ...
    def detach_devices_from_transfer_package(self, id, transfer_package_label, detach_devices_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/detach_devices_from_transfer_package.py.html>`__ to see an example of how to use detach_devices_from_transfer_package API.
        """
    ...
    def get_transfer_package(self, id, transfer_package_label, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/get_transfer_package.py.html>`__ to see an example of how to use get_transfer_package API.
        """
        resource_path = "/transferJobs/{id}/transferPackages/{transferPackageLabel}"
        method = "GET"
    ...
    def list_transfer_packages(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/list_transfer_packages.py.html>`__ to see an example of how to use list_transfer_packages API.
        """
        resource_path = "/transferJobs/{id}/transferPackages"
        method = "GET"
    ...
    def update_transfer_package(self, id, transfer_package_label, update_transfer_package_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dts/update_transfer_package.py.html>`__ to see an example of how to use update_transfer_package API.
        """
        resource_path = "/transferJobs/{id}/transferPackages/{transferPackageLabel}"
        method = "PUT"

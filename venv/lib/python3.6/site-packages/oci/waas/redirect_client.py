...
class RedirectClient(object):
    ...
    def change_http_redirect_compartment(self, http_redirect_id, change_http_redirect_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waas/change_http_redirect_compartment.py.html>`__ to see an example of how to use change_http_redirect_compartment API.
        """
    ...
    def create_http_redirect(self, create_http_redirect_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waas/create_http_redirect.py.html>`__ to see an example of how to use create_http_redirect API.
        """
    ...
    def delete_http_redirect(self, http_redirect_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waas/delete_http_redirect.py.html>`__ to see an example of how to use delete_http_redirect API.
        """
    ...
    def get_http_redirect(self, http_redirect_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waas/get_http_redirect.py.html>`__ to see an example of how to use get_http_redirect API.
        """
        resource_path = "/httpRedirects/{httpRedirectId}"
        method = "GET"
    ...
    def list_http_redirects(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waas/list_http_redirects.py.html>`__ to see an example of how to use list_http_redirects API.
        """
        resource_path = "/httpRedirects"
        method = "GET"
    ...
    def update_http_redirect(self, http_redirect_id, update_http_redirect_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waas/update_http_redirect.py.html>`__ to see an example of how to use update_http_redirect API.
        """
        resource_path = "/httpRedirects/{httpRedirectId}"
        method = "PUT"

...
class SubscriptionClient(object):
    ...
    def create_subscription_mapping(self, create_subscription_mapping_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/create_subscription_mapping.py.html>`__ to see an example of how to use create_subscription_mapping API.
        """
    ...
    def delete_subscription_mapping(self, subscription_mapping_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/delete_subscription_mapping.py.html>`__ to see an example of how to use delete_subscription_mapping API.
        """
    ...
    def get_assigned_subscription(self, assigned_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_assigned_subscription.py.html>`__ to see an example of how to use get_assigned_subscription API.
        """
    ...
    def get_subscription(self, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_subscription.py.html>`__ to see an example of how to use get_subscription API.
        """
    ...
    def get_subscription_mapping(self, subscription_mapping_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_subscription_mapping.py.html>`__ to see an example of how to use get_subscription_mapping API.
        """
        resource_path = "/subscriptionMappings/{subscriptionMappingId}"
        method = "GET"
    ...
    def list_assigned_subscriptions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_assigned_subscriptions.py.html>`__ to see an example of how to use list_assigned_subscriptions API.
        """
    ...
    def list_available_regions(self, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_available_regions.py.html>`__ to see an example of how to use list_available_regions API.
        """
    ...
    def list_subscription_mappings(self, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_subscription_mappings.py.html>`__ to see an example of how to use list_subscription_mappings API.
        """
        resource_path = "/subscriptionMappings"
        method = "GET"
    ...
    def list_subscriptions(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_subscriptions.py.html>`__ to see an example of how to use list_subscriptions API.
        """

...
class LinkClient(object):
    ...
    def delete_link(self, link_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/delete_link.py.html>`__ to see an example of how to use delete_link API.
        """
    ...
    def get_link(self, link_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_link.py.html>`__ to see an example of how to use get_link API.
        """
        resource_path = "/links/{linkId}"
        method = "GET"
    ...
    def list_links(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_links.py.html>`__ to see an example of how to use list_links API.
        """
        resource_path = "/links"
        method = "GET"

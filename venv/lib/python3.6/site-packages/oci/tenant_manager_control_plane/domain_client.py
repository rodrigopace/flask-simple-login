...
class DomainClient(object):
    ...
    def create_domain(self, create_domain_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/create_domain.py.html>`__ to see an example of how to use create_domain API.
        """
    ...
    def delete_domain(self, domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/delete_domain.py.html>`__ to see an example of how to use delete_domain API.
        """
    ...
    def get_domain(self, domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_domain.py.html>`__ to see an example of how to use get_domain API.
        """
        resource_path = "/domains/{domainId}"
        method = "GET"
    ...
    def list_domains(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_domains.py.html>`__ to see an example of how to use list_domains API.
        """
        resource_path = "/domains"
        method = "GET"
    ...
    def update_domain(self, domain_id, update_domain_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/update_domain.py.html>`__ to see an example of how to use update_domain API.
        """
        resource_path = "/domains/{domainId}"
        method = "PUT"

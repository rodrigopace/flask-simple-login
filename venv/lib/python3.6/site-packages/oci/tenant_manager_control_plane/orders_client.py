...
class OrdersClient(object):
    ...
    def activate_order(self, activate_order_details, activation_token, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/activate_order.py.html>`__ to see an example of how to use activate_order API.
        """
    ...
    def get_order(self, activation_token, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_order.py.html>`__ to see an example of how to use get_order API.
        """

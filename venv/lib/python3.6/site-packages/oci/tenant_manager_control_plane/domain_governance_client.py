...
class DomainGovernanceClient(object):
    ...
    def create_domain_governance(self, create_domain_governance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/create_domain_governance.py.html>`__ to see an example of how to use create_domain_governance API.
        """
    ...
    def delete_domain_governance(self, domain_governance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/delete_domain_governance.py.html>`__ to see an example of how to use delete_domain_governance API.
        """
    ...
    def get_domain_governance(self, domain_governance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/get_domain_governance.py.html>`__ to see an example of how to use get_domain_governance API.
        """
        resource_path = "/domainGovernances/{domainGovernanceId}"
        method = "GET"
    ...
    def list_domain_governances(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/list_domain_governances.py.html>`__ to see an example of how to use list_domain_governances API.
        """
        resource_path = "/domainGovernances"
        method = "GET"
    ...
    def update_domain_governance(self, domain_governance_id, update_domain_governance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/tenantmanagercontrolplane/update_domain_governance.py.html>`__ to see an example of how to use update_domain_governance API.
        """
        resource_path = "/domainGovernances/{domainGovernanceId}"
        method = "PUT"

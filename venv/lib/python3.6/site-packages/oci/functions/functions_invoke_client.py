...
class FunctionsInvokeClient(object):
    ...
    def invoke_function(self, function_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/invoke_function.py.html>`__ to see an example of how to use invoke_function API.
        """

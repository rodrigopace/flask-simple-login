...
class FunctionsManagementClient(object):
    ...
    def change_application_compartment(self, application_id, change_application_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/change_application_compartment.py.html>`__ to see an example of how to use change_application_compartment API.
        """
    ...
    def create_application(self, create_application_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/create_application.py.html>`__ to see an example of how to use create_application API.
        """
    ...
    def create_function(self, create_function_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/create_function.py.html>`__ to see an example of how to use create_function API.
        """
    ...
    def delete_application(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/delete_application.py.html>`__ to see an example of how to use delete_application API.
        """
    ...
    def delete_function(self, function_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/delete_function.py.html>`__ to see an example of how to use delete_function API.
        """
    ...
    def get_application(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/get_application.py.html>`__ to see an example of how to use get_application API.
        """
        resource_path = "/applications/{applicationId}"
        method = "GET"
    ...
    def get_function(self, function_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/get_function.py.html>`__ to see an example of how to use get_function API.
        """
        resource_path = "/functions/{functionId}"
        method = "GET"
    ...
    def list_applications(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/list_applications.py.html>`__ to see an example of how to use list_applications API.
        """
        resource_path = "/applications"
        method = "GET"
    ...
    def list_functions(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/list_functions.py.html>`__ to see an example of how to use list_functions API.
        """
        resource_path = "/functions"
        method = "GET"
    ...
    def update_application(self, application_id, update_application_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/update_application.py.html>`__ to see an example of how to use update_application API.
        """
        resource_path = "/applications/{applicationId}"
        method = "PUT"
    ...
    def update_function(self, function_id, update_function_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/functions/update_function.py.html>`__ to see an example of how to use update_function API.
        """
        resource_path = "/functions/{functionId}"
        method = "PUT"

...
class RoverEntitlementClient(object):
    ...
    def change_rover_entitlement_compartment(self, rover_entitlement_id, change_rover_entitlement_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/change_rover_entitlement_compartment.py.html>`__ to see an example of how to use change_rover_entitlement_compartment API.
        """
    ...
    def create_rover_entitlement(self, create_rover_entitlement_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/create_rover_entitlement.py.html>`__ to see an example of how to use create_rover_entitlement API.
        """
    ...
    def delete_rover_entitlement(self, rover_entitlement_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/delete_rover_entitlement.py.html>`__ to see an example of how to use delete_rover_entitlement API.
        """
    ...
    def get_rover_entitlement(self, rover_entitlement_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_entitlement.py.html>`__ to see an example of how to use get_rover_entitlement API.
        """
        resource_path = "/roverEntitlements/{roverEntitlementId}"
        method = "GET"
    ...
    def list_rover_entitlements(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/list_rover_entitlements.py.html>`__ to see an example of how to use list_rover_entitlements API.
        """
        resource_path = "/roverEntitlements"
        method = "GET"
    ...
    def update_rover_entitlement(self, rover_entitlement_id, update_rover_entitlement_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/update_rover_entitlement.py.html>`__ to see an example of how to use update_rover_entitlement API.
        """
        resource_path = "/roverEntitlements/{roverEntitlementId}"
        method = "PUT"

...
class RoverNodeClient(object):
    ...
    def change_rover_node_compartment(self, rover_node_id, change_rover_node_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/change_rover_node_compartment.py.html>`__ to see an example of how to use change_rover_node_compartment API.
        """
    ...
    def create_rover_node(self, create_rover_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/create_rover_node.py.html>`__ to see an example of how to use create_rover_node API.
        """
    ...
    def delete_rover_node(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/delete_rover_node.py.html>`__ to see an example of how to use delete_rover_node API.
        """
    ...
    def get_rover_node(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_node.py.html>`__ to see an example of how to use get_rover_node API.
        """
        resource_path = "/roverNodes/{roverNodeId}"
        method = "GET"
    ...
    def get_rover_node_certificate(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_node_certificate.py.html>`__ to see an example of how to use get_rover_node_certificate API.
        """
    ...
    def get_rover_node_encryption_key(self, rover_node_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_node_encryption_key.py.html>`__ to see an example of how to use get_rover_node_encryption_key API.
        """
    ...
    def get_rover_node_get_rpt(self, rover_node_id, jwt, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_node_get_rpt.py.html>`__ to see an example of how to use get_rover_node_get_rpt API.
        """
    ...
    def list_rover_nodes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/list_rover_nodes.py.html>`__ to see an example of how to use list_rover_nodes API.
        """
        resource_path = "/roverNodes"
        method = "GET"
    ...
    def rover_node_action_set_key(self, rover_node_id, jwt, rover_node_action_set_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/rover_node_action_set_key.py.html>`__ to see an example of how to use rover_node_action_set_key API.
        """
    ...
    def update_rover_node(self, rover_node_id, update_rover_node_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/update_rover_node.py.html>`__ to see an example of how to use update_rover_node API.
        """
        resource_path = "/roverNodes/{roverNodeId}"
        method = "PUT"

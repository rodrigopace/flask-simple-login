...
class RoverClusterClient(object):
    ...
    def change_rover_cluster_compartment(self, rover_cluster_id, change_rover_cluster_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/change_rover_cluster_compartment.py.html>`__ to see an example of how to use change_rover_cluster_compartment API.
        """
    ...
    def create_rover_cluster(self, create_rover_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/create_rover_cluster.py.html>`__ to see an example of how to use create_rover_cluster API.
        """
    ...
    def delete_rover_cluster(self, rover_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/delete_rover_cluster.py.html>`__ to see an example of how to use delete_rover_cluster API.
        """
    ...
    def get_rover_cluster(self, rover_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_cluster.py.html>`__ to see an example of how to use get_rover_cluster API.
        """
        resource_path = "/roverClusters/{roverClusterId}"
        method = "GET"
    ...
    def get_rover_cluster_certificate(self, rover_cluster_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/get_rover_cluster_certificate.py.html>`__ to see an example of how to use get_rover_cluster_certificate API.
        """
    ...
    def list_rover_clusters(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/list_rover_clusters.py.html>`__ to see an example of how to use list_rover_clusters API.
        """
        resource_path = "/roverClusters"
        method = "GET"
    ...
    def update_rover_cluster(self, rover_cluster_id, update_rover_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/rover/update_rover_cluster.py.html>`__ to see an example of how to use update_rover_cluster API.
        """
        resource_path = "/roverClusters/{roverClusterId}"
        method = "PUT"

...
class NotificationControlPlaneClient(object):
    ...
    def change_topic_compartment(self, topic_id, change_topic_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/change_topic_compartment.py.html>`__ to see an example of how to use change_topic_compartment API.
        """
    ...
    def create_topic(self, create_topic_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/create_topic.py.html>`__ to see an example of how to use create_topic API.
        """
    ...
    def delete_topic(self, topic_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/delete_topic.py.html>`__ to see an example of how to use delete_topic API.
        """
    ...
    def get_topic(self, topic_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/get_topic.py.html>`__ to see an example of how to use get_topic API.
        """
        resource_path = "/topics/{topicId}"
        method = "GET"
    ...
    def list_topics(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/list_topics.py.html>`__ to see an example of how to use list_topics API.
        """
        resource_path = "/topics"
        method = "GET"
    ...
    def update_topic(self, topic_id, topic_attributes_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/update_topic.py.html>`__ to see an example of how to use update_topic API.
        """
        resource_path = "/topics/{topicId}"
        method = "PUT"

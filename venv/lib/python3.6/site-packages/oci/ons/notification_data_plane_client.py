...
class NotificationDataPlaneClient(object):
    ...
    def change_subscription_compartment(self, subscription_id, change_subscription_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/change_subscription_compartment.py.html>`__ to see an example of how to use change_subscription_compartment API.
        """
    ...
    def create_subscription(self, create_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/create_subscription.py.html>`__ to see an example of how to use create_subscription API.
        """
    ...
    def delete_subscription(self, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/delete_subscription.py.html>`__ to see an example of how to use delete_subscription API.
        """
    ...
    def get_confirm_subscription(self, id, token, protocol, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/get_confirm_subscription.py.html>`__ to see an example of how to use get_confirm_subscription API.
        """
    ...
    def get_subscription(self, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/get_subscription.py.html>`__ to see an example of how to use get_subscription API.
        """
        resource_path = "/subscriptions/{subscriptionId}"
        method = "GET"
    ...
    def get_unsubscription(self, id, token, protocol, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/get_unsubscription.py.html>`__ to see an example of how to use get_unsubscription API.
        """
    ...
    def list_subscriptions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/list_subscriptions.py.html>`__ to see an example of how to use list_subscriptions API.
        """
        resource_path = "/subscriptions"
        method = "GET"
    ...
    def publish_message(self, topic_id, message_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/publish_message.py.html>`__ to see an example of how to use publish_message API.
        """
    ...
    def resend_subscription_confirmation(self, id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/resend_subscription_confirmation.py.html>`__ to see an example of how to use resend_subscription_confirmation API.
        """
    ...
    def update_subscription(self, subscription_id, update_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ons/update_subscription.py.html>`__ to see an example of how to use update_subscription API.
        """
        resource_path = "/subscriptions/{subscriptionId}"
        method = "PUT"

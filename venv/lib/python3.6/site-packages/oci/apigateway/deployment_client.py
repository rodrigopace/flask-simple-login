...
class DeploymentClient(object):
    ...
    def change_deployment_compartment(self, deployment_id, change_deployment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/change_deployment_compartment.py.html>`__ to see an example of how to use change_deployment_compartment API.
        """
    ...
    def create_deployment(self, create_deployment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/create_deployment.py.html>`__ to see an example of how to use create_deployment API.
        """
    ...
    def delete_deployment(self, deployment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/delete_deployment.py.html>`__ to see an example of how to use delete_deployment API.
        """
    ...
    def get_deployment(self, deployment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/get_deployment.py.html>`__ to see an example of how to use get_deployment API.
        """
        resource_path = "/deployments/{deploymentId}"
        method = "GET"
    ...
    def list_deployments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/list_deployments.py.html>`__ to see an example of how to use list_deployments API.
        """
        resource_path = "/deployments"
        method = "GET"
    ...
    def update_deployment(self, deployment_id, update_deployment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/update_deployment.py.html>`__ to see an example of how to use update_deployment API.
        """
        resource_path = "/deployments/{deploymentId}"
        method = "PUT"

...
class GatewayClient(object):
    ...
    def change_gateway_compartment(self, gateway_id, change_gateway_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/change_gateway_compartment.py.html>`__ to see an example of how to use change_gateway_compartment API.
        """
    ...
    def create_gateway(self, create_gateway_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/create_gateway.py.html>`__ to see an example of how to use create_gateway API.
        """
    ...
    def delete_gateway(self, gateway_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/delete_gateway.py.html>`__ to see an example of how to use delete_gateway API.
        """
    ...
    def get_gateway(self, gateway_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/get_gateway.py.html>`__ to see an example of how to use get_gateway API.
        """
        resource_path = "/gateways/{gatewayId}"
        method = "GET"
    ...
    def list_gateways(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/list_gateways.py.html>`__ to see an example of how to use list_gateways API.
        """
        resource_path = "/gateways"
        method = "GET"
    ...
    def update_gateway(self, gateway_id, update_gateway_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apigateway/update_gateway.py.html>`__ to see an example of how to use update_gateway API.
        """
        resource_path = "/gateways/{gatewayId}"
        method = "PUT"

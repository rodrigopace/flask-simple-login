...
class SecretsClient(object):
    ...
    def get_secret_bundle(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/secrets/get_secret_bundle.py.html>`__ to see an example of how to use get_secret_bundle API.
        """
    ...
    def get_secret_bundle_by_name(self, secret_name, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/secrets/get_secret_bundle_by_name.py.html>`__ to see an example of how to use get_secret_bundle_by_name API.
        """
    ...
    def list_secret_bundle_versions(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/secrets/list_secret_bundle_versions.py.html>`__ to see an example of how to use list_secret_bundle_versions API.
        """

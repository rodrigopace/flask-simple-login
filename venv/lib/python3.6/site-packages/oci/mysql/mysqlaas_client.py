...
class MysqlaasClient(object):
    ...
    def create_configuration(self, create_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/create_configuration.py.html>`__ to see an example of how to use create_configuration API.
        """
    ...
    def delete_configuration(self, configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/delete_configuration.py.html>`__ to see an example of how to use delete_configuration API.
        """
    ...
    def get_configuration(self, configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_configuration.py.html>`__ to see an example of how to use get_configuration API.
        """
        resource_path = "/configurations/{configurationId}"
        method = "GET"
    ...
    def list_configurations(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/list_configurations.py.html>`__ to see an example of how to use list_configurations API.
        """
        resource_path = "/configurations"
        method = "GET"
    ...
    def list_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/list_shapes.py.html>`__ to see an example of how to use list_shapes API.
        """
    ...
    def list_versions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/list_versions.py.html>`__ to see an example of how to use list_versions API.
        """
    ...
    def update_configuration(self, configuration_id, update_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/update_configuration.py.html>`__ to see an example of how to use update_configuration API.
        """
        resource_path = "/configurations/{configurationId}"
        method = "PUT"

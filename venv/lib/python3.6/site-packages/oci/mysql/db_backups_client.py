...
class DbBackupsClient(object):
    ...
    def change_backup_compartment(self, backup_id, change_backup_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/change_backup_compartment.py.html>`__ to see an example of how to use change_backup_compartment API.
        """
    ...
    def create_backup(self, create_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/create_backup.py.html>`__ to see an example of how to use create_backup API.
        """
    ...
    def delete_backup(self, backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/delete_backup.py.html>`__ to see an example of how to use delete_backup API.
        """
    ...
    def get_backup(self, backup_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_backup.py.html>`__ to see an example of how to use get_backup API.
        """
        resource_path = "/backups/{backupId}"
        method = "GET"
    ...
    def list_backups(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/list_backups.py.html>`__ to see an example of how to use list_backups API.
        """
        resource_path = "/backups"
        method = "GET"
    ...
    def update_backup(self, backup_id, update_backup_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/update_backup.py.html>`__ to see an example of how to use update_backup API.
        """
        resource_path = "/backups/{backupId}"
        method = "PUT"

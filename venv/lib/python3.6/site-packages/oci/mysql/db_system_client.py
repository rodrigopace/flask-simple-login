...
class DbSystemClient(object):
    ...
    def add_analytics_cluster(self, db_system_id, add_analytics_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/add_analytics_cluster.py.html>`__ to see an example of how to use add_analytics_cluster API.
        """
    ...
    def add_heat_wave_cluster(self, db_system_id, add_heat_wave_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/add_heat_wave_cluster.py.html>`__ to see an example of how to use add_heat_wave_cluster API.
        """
    ...
    def create_db_system(self, create_db_system_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/create_db_system.py.html>`__ to see an example of how to use create_db_system API.
        """
    ...
    def delete_analytics_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/delete_analytics_cluster.py.html>`__ to see an example of how to use delete_analytics_cluster API.
        """
    ...
    def delete_db_system(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/delete_db_system.py.html>`__ to see an example of how to use delete_db_system API.
        """
    ...
    def delete_heat_wave_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/delete_heat_wave_cluster.py.html>`__ to see an example of how to use delete_heat_wave_cluster API.
        """
    ...
    def generate_analytics_cluster_memory_estimate(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/generate_analytics_cluster_memory_estimate.py.html>`__ to see an example of how to use generate_analytics_cluster_memory_estimate API.
        """
    ...
    def generate_heat_wave_cluster_memory_estimate(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/generate_heat_wave_cluster_memory_estimate.py.html>`__ to see an example of how to use generate_heat_wave_cluster_memory_estimate API.
        """
    ...
    def get_analytics_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_analytics_cluster.py.html>`__ to see an example of how to use get_analytics_cluster API.
        """
        resource_path = "/dbSystems/{dbSystemId}/analyticsCluster"
        method = "GET"
    ...
    def get_analytics_cluster_memory_estimate(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_analytics_cluster_memory_estimate.py.html>`__ to see an example of how to use get_analytics_cluster_memory_estimate API.
        """
    ...
    def get_db_system(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_db_system.py.html>`__ to see an example of how to use get_db_system API.
        """
        resource_path = "/dbSystems/{dbSystemId}"
        method = "GET"
    ...
    def get_heat_wave_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_heat_wave_cluster.py.html>`__ to see an example of how to use get_heat_wave_cluster API.
        """
        resource_path = "/dbSystems/{dbSystemId}/heatWaveCluster"
        method = "GET"
    ...
    def get_heat_wave_cluster_memory_estimate(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_heat_wave_cluster_memory_estimate.py.html>`__ to see an example of how to use get_heat_wave_cluster_memory_estimate API.
        """
    ...
    def list_db_systems(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/list_db_systems.py.html>`__ to see an example of how to use list_db_systems API.
        """
        resource_path = "/dbSystems"
        method = "GET"
    ...
    def restart_analytics_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/restart_analytics_cluster.py.html>`__ to see an example of how to use restart_analytics_cluster API.
        """
    ...
    def restart_db_system(self, db_system_id, restart_db_system_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/restart_db_system.py.html>`__ to see an example of how to use restart_db_system API.
        """
    ...
    def restart_heat_wave_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/restart_heat_wave_cluster.py.html>`__ to see an example of how to use restart_heat_wave_cluster API.
        """
    ...
    def start_analytics_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/start_analytics_cluster.py.html>`__ to see an example of how to use start_analytics_cluster API.
        """
    ...
    def start_db_system(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/start_db_system.py.html>`__ to see an example of how to use start_db_system API.
        """
    ...
    def start_heat_wave_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/start_heat_wave_cluster.py.html>`__ to see an example of how to use start_heat_wave_cluster API.
        """
    ...
    def stop_analytics_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/stop_analytics_cluster.py.html>`__ to see an example of how to use stop_analytics_cluster API.
        """
    ...
    def stop_db_system(self, db_system_id, stop_db_system_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/stop_db_system.py.html>`__ to see an example of how to use stop_db_system API.
        """
    ...
    def stop_heat_wave_cluster(self, db_system_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/stop_heat_wave_cluster.py.html>`__ to see an example of how to use stop_heat_wave_cluster API.
        """
    ...
    def update_analytics_cluster(self, db_system_id, update_analytics_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/update_analytics_cluster.py.html>`__ to see an example of how to use update_analytics_cluster API.
        """
        resource_path = "/dbSystems/{dbSystemId}/analyticsCluster"
        method = "PUT"
    ...
    def update_db_system(self, db_system_id, update_db_system_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/update_db_system.py.html>`__ to see an example of how to use update_db_system API.
        """
        resource_path = "/dbSystems/{dbSystemId}"
        method = "PUT"
    ...
    def update_heat_wave_cluster(self, db_system_id, update_heat_wave_cluster_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/update_heat_wave_cluster.py.html>`__ to see an example of how to use update_heat_wave_cluster API.
        """
        resource_path = "/dbSystems/{dbSystemId}/heatWaveCluster"
        method = "PUT"

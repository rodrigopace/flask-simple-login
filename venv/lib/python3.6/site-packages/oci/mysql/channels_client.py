...
class ChannelsClient(object):
    ...
    def create_channel(self, create_channel_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/create_channel.py.html>`__ to see an example of how to use create_channel API.
        """
    ...
    def delete_channel(self, channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/delete_channel.py.html>`__ to see an example of how to use delete_channel API.
        """
    ...
    def get_channel(self, channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/get_channel.py.html>`__ to see an example of how to use get_channel API.
        """
        resource_path = "/channels/{channelId}"
        method = "GET"
    ...
    def list_channels(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/list_channels.py.html>`__ to see an example of how to use list_channels API.
        """
        resource_path = "/channels"
        method = "GET"
    ...
    def reset_channel(self, channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/reset_channel.py.html>`__ to see an example of how to use reset_channel API.
        """
    ...
    def resume_channel(self, channel_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/resume_channel.py.html>`__ to see an example of how to use resume_channel API.
        """
    ...
    def update_channel(self, channel_id, update_channel_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mysql/update_channel.py.html>`__ to see an example of how to use update_channel API.
        """
        resource_path = "/channels/{channelId}"
        method = "PUT"

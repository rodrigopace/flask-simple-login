...
class AnnouncementSubscriptionClient(object):
    ...
    def change_announcement_subscription_compartment(self, announcement_subscription_id, change_announcement_subscription_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/change_announcement_subscription_compartment.py.html>`__ to see an example of how to use change_announcement_subscription_compartment API.
        """
    ...
    def create_announcement_subscription(self, create_announcement_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/create_announcement_subscription.py.html>`__ to see an example of how to use create_announcement_subscription API.
        """
    ...
    def create_filter_group(self, announcement_subscription_id, create_filter_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/create_filter_group.py.html>`__ to see an example of how to use create_filter_group API.
        """
    ...
    def delete_announcement_subscription(self, announcement_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/delete_announcement_subscription.py.html>`__ to see an example of how to use delete_announcement_subscription API.
        """
    ...
    def delete_filter_group(self, announcement_subscription_id, filter_group_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/delete_filter_group.py.html>`__ to see an example of how to use delete_filter_group API.
        """
    ...
    def get_announcement_subscription(self, announcement_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/get_announcement_subscription.py.html>`__ to see an example of how to use get_announcement_subscription API.
        """
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}"
        method = "GET"
    ...
    def list_announcement_subscriptions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/list_announcement_subscriptions.py.html>`__ to see an example of how to use list_announcement_subscriptions API.
        """
        resource_path = "/announcementSubscriptions"
        method = "GET"
    ...
    def update_announcement_subscription(self, announcement_subscription_id, update_announcement_subscription_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/update_announcement_subscription.py.html>`__ to see an example of how to use update_announcement_subscription API.
        """
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}"
        method = "PUT"
    ...
    def update_filter_group(self, announcement_subscription_id, filter_group_name, update_filter_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/update_filter_group.py.html>`__ to see an example of how to use update_filter_group API.
        """
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}/filterGroups/{filterGroupName}"
        method = "PUT"

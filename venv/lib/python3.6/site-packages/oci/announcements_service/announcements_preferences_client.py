...
class AnnouncementsPreferencesClient(object):
    ...
    def create_announcements_preference(self, announcements_preference_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/create_announcements_preference.py.html>`__ to see an example of how to use create_announcements_preference API.
        """
    ...
    def get_announcements_preference(self, preference_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/get_announcements_preference.py.html>`__ to see an example of how to use get_announcements_preference API.
        """
    ...
    def list_announcements_preferences(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/list_announcements_preferences.py.html>`__ to see an example of how to use list_announcements_preferences API.
        """
        resource_path = "/announcementsPreferences"
        method = "GET"
    ...
    def update_announcements_preference(self, preference_id, announcements_preference_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/announcementsservice/update_announcements_preference.py.html>`__ to see an example of how to use update_announcements_preference API.
        """
        resource_path = "/announcementsPreferences/{preferenceId}"
        method = "PUT"

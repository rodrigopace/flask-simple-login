...
class HealthChecksClient(object):
    ...
    def change_http_monitor_compartment(self, monitor_id, change_http_monitor_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/change_http_monitor_compartment.py.html>`__ to see an example of how to use change_http_monitor_compartment API.
        """
    ...
    def change_ping_monitor_compartment(self, monitor_id, change_ping_monitor_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/change_ping_monitor_compartment.py.html>`__ to see an example of how to use change_ping_monitor_compartment API.
        """
    ...
    def create_http_monitor(self, create_http_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/create_http_monitor.py.html>`__ to see an example of how to use create_http_monitor API.
        """
    ...
    def create_on_demand_http_probe(self, create_on_demand_http_probe_details, **kwargs):
        ...
        *Note:* On-demand probe configurations are not saved.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/create_on_demand_http_probe.py.html>`__ to see an example of how to use create_on_demand_http_probe API.
        """
    ...
    def create_on_demand_ping_probe(self, create_on_demand_ping_probe_details, **kwargs):
        ...
        *Note:* The on-demand probe configuration is not saved.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/create_on_demand_ping_probe.py.html>`__ to see an example of how to use create_on_demand_ping_probe API.
        """
    ...
    def create_ping_monitor(self, create_ping_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/create_ping_monitor.py.html>`__ to see an example of how to use create_ping_monitor API.
        """
    ...
    def delete_http_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/delete_http_monitor.py.html>`__ to see an example of how to use delete_http_monitor API.
        """
    ...
    def delete_ping_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/delete_ping_monitor.py.html>`__ to see an example of how to use delete_ping_monitor API.
        """
    ...
    def get_http_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/get_http_monitor.py.html>`__ to see an example of how to use get_http_monitor API.
        """
        resource_path = "/httpMonitors/{monitorId}"
        method = "GET"
    ...
    def get_ping_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/get_ping_monitor.py.html>`__ to see an example of how to use get_ping_monitor API.
        """
        resource_path = "/pingMonitors/{monitorId}"
        method = "GET"
    ...
    def list_health_checks_vantage_points(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/list_health_checks_vantage_points.py.html>`__ to see an example of how to use list_health_checks_vantage_points API.
        """
    ...
    def list_http_monitors(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/list_http_monitors.py.html>`__ to see an example of how to use list_http_monitors API.
        """
        resource_path = "/httpMonitors"
        method = "GET"
    ...
    def list_http_probe_results(self, probe_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/list_http_probe_results.py.html>`__ to see an example of how to use list_http_probe_results API.
        """
    ...
    def list_ping_monitors(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/list_ping_monitors.py.html>`__ to see an example of how to use list_ping_monitors API.
        """
        resource_path = "/pingMonitors"
        method = "GET"
    ...
    def list_ping_probe_results(self, probe_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/list_ping_probe_results.py.html>`__ to see an example of how to use list_ping_probe_results API.
        """
    ...
    def update_http_monitor(self, monitor_id, update_http_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/update_http_monitor.py.html>`__ to see an example of how to use update_http_monitor API.
        """
        resource_path = "/httpMonitors/{monitorId}"
        method = "PUT"
    ...
    def update_ping_monitor(self, monitor_id, update_ping_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/healthchecks/update_ping_monitor.py.html>`__ to see an example of how to use update_ping_monitor API.
        """
        resource_path = "/pingMonitors/{monitorId}"
        method = "PUT"

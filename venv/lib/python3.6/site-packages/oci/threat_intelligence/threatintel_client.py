...
class ThreatintelClient(object):
    ...
    def get_indicator(self, indicator_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/threatintelligence/get_indicator.py.html>`__ to see an example of how to use get_indicator API.
        """
    ...
    def list_indicator_counts(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/threatintelligence/list_indicator_counts.py.html>`__ to see an example of how to use list_indicator_counts API.
        """
    ...
    def list_indicators(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/threatintelligence/list_indicators.py.html>`__ to see an example of how to use list_indicators API.
        """
    ...
    def list_threat_types(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/threatintelligence/list_threat_types.py.html>`__ to see an example of how to use list_threat_types API.
        """

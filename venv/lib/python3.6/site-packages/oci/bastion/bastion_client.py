...
class BastionClient(object):
    ...
    def change_bastion_compartment(self, bastion_id, change_bastion_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/change_bastion_compartment.py.html>`__ to see an example of how to use change_bastion_compartment API.
        """
    ...
    def create_bastion(self, create_bastion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/create_bastion.py.html>`__ to see an example of how to use create_bastion API.
        """
    ...
    def create_session(self, create_session_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/create_session.py.html>`__ to see an example of how to use create_session API.
        """
    ...
    def delete_bastion(self, bastion_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/delete_bastion.py.html>`__ to see an example of how to use delete_bastion API.
        """
    ...
    def delete_session(self, session_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/delete_session.py.html>`__ to see an example of how to use delete_session API.
        """
    ...
    def get_bastion(self, bastion_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/get_bastion.py.html>`__ to see an example of how to use get_bastion API.
        """
        resource_path = "/bastions/{bastionId}"
        method = "GET"
    ...
    def get_session(self, session_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/get_session.py.html>`__ to see an example of how to use get_session API.
        """
        resource_path = "/sessions/{sessionId}"
        method = "GET"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_bastions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/list_bastions.py.html>`__ to see an example of how to use list_bastions API.
        """
        resource_path = "/bastions"
        method = "GET"
    ...
    def list_sessions(self, bastion_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/list_sessions.py.html>`__ to see an example of how to use list_sessions API.
        """
        resource_path = "/sessions"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_bastion(self, bastion_id, update_bastion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/update_bastion.py.html>`__ to see an example of how to use update_bastion API.
        """
        resource_path = "/bastions/{bastionId}"
        method = "PUT"
    ...
    def update_session(self, session_id, update_session_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/bastion/update_session.py.html>`__ to see an example of how to use update_session API.
        """
        resource_path = "/sessions/{sessionId}"
        method = "PUT"

...
class ApmSyntheticClient(object):
    ...
    def aggregate_network_data(self, apm_domain_id, monitor_id, aggregate_network_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/aggregate_network_data.py.html>`__ to see an example of how to use aggregate_network_data API.
        """
    ...
    def create_dedicated_vantage_point(self, apm_domain_id, create_dedicated_vantage_point_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/create_dedicated_vantage_point.py.html>`__ to see an example of how to use create_dedicated_vantage_point API.
        """
    ...
    def create_monitor(self, apm_domain_id, create_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/create_monitor.py.html>`__ to see an example of how to use create_monitor API.
        """
    ...
    def create_script(self, apm_domain_id, create_script_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/create_script.py.html>`__ to see an example of how to use create_script API.
        """
    ...
    def delete_dedicated_vantage_point(self, apm_domain_id, dedicated_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/delete_dedicated_vantage_point.py.html>`__ to see an example of how to use delete_dedicated_vantage_point API.
        """
    ...
    def delete_monitor(self, apm_domain_id, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/delete_monitor.py.html>`__ to see an example of how to use delete_monitor API.
        """
    ...
    def delete_script(self, apm_domain_id, script_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/delete_script.py.html>`__ to see an example of how to use delete_script API.
        """
    ...
    def get_dedicated_vantage_point(self, apm_domain_id, dedicated_vantage_point_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/get_dedicated_vantage_point.py.html>`__ to see an example of how to use get_dedicated_vantage_point API.
        """
        resource_path = "/dedicatedVantagePoints/{dedicatedVantagePointId}"
        method = "GET"
    ...
    def get_monitor(self, apm_domain_id, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/get_monitor.py.html>`__ to see an example of how to use get_monitor API.
        """
        resource_path = "/monitors/{monitorId}"
        method = "GET"
    ...
    def get_monitor_result(self, apm_domain_id, monitor_id, vantage_point, result_type, result_content_type, execution_time, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/get_monitor_result.py.html>`__ to see an example of how to use get_monitor_result API.
        """
    ...
    def get_script(self, apm_domain_id, script_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/get_script.py.html>`__ to see an example of how to use get_script API.
        """
        resource_path = "/scripts/{scriptId}"
        method = "GET"
    ...
    def list_dedicated_vantage_points(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/list_dedicated_vantage_points.py.html>`__ to see an example of how to use list_dedicated_vantage_points API.
        """
        resource_path = "/dedicatedVantagePoints"
        method = "GET"
    ...
    def list_monitors(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/list_monitors.py.html>`__ to see an example of how to use list_monitors API.
        """
        resource_path = "/monitors"
        method = "GET"
    ...
    def list_public_vantage_points(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/list_public_vantage_points.py.html>`__ to see an example of how to use list_public_vantage_points API.
        """
    ...
    def list_scripts(self, apm_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/list_scripts.py.html>`__ to see an example of how to use list_scripts API.
        """
        resource_path = "/scripts"
        method = "GET"
    ...
    def update_dedicated_vantage_point(self, apm_domain_id, dedicated_vantage_point_id, update_dedicated_vantage_point_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/update_dedicated_vantage_point.py.html>`__ to see an example of how to use update_dedicated_vantage_point API.
        """
        resource_path = "/dedicatedVantagePoints/{dedicatedVantagePointId}"
        method = "PUT"
    ...
    def update_monitor(self, apm_domain_id, monitor_id, update_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/update_monitor.py.html>`__ to see an example of how to use update_monitor API.
        """
        resource_path = "/monitors/{monitorId}"
        method = "PUT"
    ...
    def update_script(self, apm_domain_id, script_id, update_script_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmsynthetics/update_script.py.html>`__ to see an example of how to use update_script API.
        """
        resource_path = "/scripts/{scriptId}"
        method = "PUT"

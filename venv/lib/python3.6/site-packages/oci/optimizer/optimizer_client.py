...
class OptimizerClient(object):
    ...
    def bulk_apply_recommendations(self, recommendation_id, bulk_apply_recommendations_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/bulk_apply_recommendations.py.html>`__ to see an example of how to use bulk_apply_recommendations API.
        """
    ...
    def create_profile(self, create_profile_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/create_profile.py.html>`__ to see an example of how to use create_profile API.
        """
    ...
    def delete_profile(self, profile_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/delete_profile.py.html>`__ to see an example of how to use delete_profile API.
        """
    ...
    def filter_resource_actions(self, compartment_id, compartment_id_in_subtree, query_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/filter_resource_actions.py.html>`__ to see an example of how to use filter_resource_actions API.
        """
    ...
    def get_category(self, category_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/get_category.py.html>`__ to see an example of how to use get_category API.
        """
    ...
    def get_enrollment_status(self, enrollment_status_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/get_enrollment_status.py.html>`__ to see an example of how to use get_enrollment_status API.
        """
    ...
    def get_profile(self, profile_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/get_profile.py.html>`__ to see an example of how to use get_profile API.
        """
        resource_path = "/profiles/{profileId}"
        method = "GET"
    ...
    def get_recommendation(self, recommendation_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/get_recommendation.py.html>`__ to see an example of how to use get_recommendation API.
        """
    ...
    def get_resource_action(self, resource_action_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/get_resource_action.py.html>`__ to see an example of how to use get_resource_action API.
        """
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_categories(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_categories.py.html>`__ to see an example of how to use list_categories API.
        """
    ...
    def list_enrollment_statuses(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_enrollment_statuses.py.html>`__ to see an example of how to use list_enrollment_statuses API.
        """
    ...
    def list_histories(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_histories.py.html>`__ to see an example of how to use list_histories API.
        """
    ...
    def list_profile_levels(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_profile_levels.py.html>`__ to see an example of how to use list_profile_levels API.
        """
    ...
    def list_profiles(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_profiles.py.html>`__ to see an example of how to use list_profiles API.
        """
        resource_path = "/profiles"
        method = "GET"
    ...
    def list_recommendation_strategies(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_recommendation_strategies.py.html>`__ to see an example of how to use list_recommendation_strategies API.
        """
    ...
    def list_recommendations(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_recommendations.py.html>`__ to see an example of how to use list_recommendations API.
        """
    ...
    def list_resource_action_queryable_fields(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_resource_action_queryable_fields.py.html>`__ to see an example of how to use list_resource_action_queryable_fields API.
        """
    ...
    def list_resource_actions(self, compartment_id, compartment_id_in_subtree, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_resource_actions.py.html>`__ to see an example of how to use list_resource_actions API.
        """
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_enrollment_status(self, enrollment_status_id, update_enrollment_status_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/update_enrollment_status.py.html>`__ to see an example of how to use update_enrollment_status API.
        """
        resource_path = "/enrollmentStatus/{enrollmentStatusId}"
        method = "PUT"
    ...
    def update_profile(self, profile_id, update_profile_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/update_profile.py.html>`__ to see an example of how to use update_profile API.
        """
        resource_path = "/profiles/{profileId}"
        method = "PUT"
    ...
    def update_recommendation(self, recommendation_id, update_recommendation_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/update_recommendation.py.html>`__ to see an example of how to use update_recommendation API.
        """
        resource_path = "/recommendations/{recommendationId}"
        method = "PUT"
    ...
    def update_resource_action(self, resource_action_id, update_resource_action_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/optimizer/update_resource_action.py.html>`__ to see an example of how to use update_resource_action API.
        """
        resource_path = "/resourceActions/{resourceActionId}"
        method = "PUT"

...
class AnomalyDetectionClient(object):
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
    ...
    def change_ai_private_endpoint_compartment(self, ai_private_endpoint_id, change_ai_private_endpoint_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/change_ai_private_endpoint_compartment.py.html>`__ to see an example of how to use change_ai_private_endpoint_compartment API.
        """
    ...
    def change_data_asset_compartment(self, data_asset_id, change_data_asset_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/change_data_asset_compartment.py.html>`__ to see an example of how to use change_data_asset_compartment API.
        """
    ...
    def change_model_compartment(self, model_id, change_model_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/change_model_compartment.py.html>`__ to see an example of how to use change_model_compartment API.
        """
    ...
    def change_project_compartment(self, project_id, change_project_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/change_project_compartment.py.html>`__ to see an example of how to use change_project_compartment API.
        """
    ...
    def create_ai_private_endpoint(self, create_ai_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/create_ai_private_endpoint.py.html>`__ to see an example of how to use create_ai_private_endpoint API.
        """
    ...
    def create_data_asset(self, create_data_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/create_data_asset.py.html>`__ to see an example of how to use create_data_asset API.
        """
    ...
    def create_model(self, create_model_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/create_model.py.html>`__ to see an example of how to use create_model API.
        """
    ...
    def create_project(self, create_project_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/create_project.py.html>`__ to see an example of how to use create_project API.
        """
    ...
    def delete_ai_private_endpoint(self, ai_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/delete_ai_private_endpoint.py.html>`__ to see an example of how to use delete_ai_private_endpoint API.
        """
    ...
    def delete_data_asset(self, data_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/delete_data_asset.py.html>`__ to see an example of how to use delete_data_asset API.
        """
    ...
    def delete_model(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/delete_model.py.html>`__ to see an example of how to use delete_model API.
        """
    ...
    def delete_project(self, project_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/delete_project.py.html>`__ to see an example of how to use delete_project API.
        """
    ...
    def detect_anomalies(self, detect_anomalies_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/detect_anomalies.py.html>`__ to see an example of how to use detect_anomalies API.
        """
    ...
    def get_ai_private_endpoint(self, ai_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/get_ai_private_endpoint.py.html>`__ to see an example of how to use get_ai_private_endpoint API.
        """
        resource_path = "/aiPrivateEndpoints/{aiPrivateEndpointId}"
        method = "GET"
    ...
    def get_data_asset(self, data_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/get_data_asset.py.html>`__ to see an example of how to use get_data_asset API.
        """
        resource_path = "/dataAssets/{dataAssetId}"
        method = "GET"
    ...
    def get_model(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/get_model.py.html>`__ to see an example of how to use get_model API.
        """
        resource_path = "/models/{modelId}"
        method = "GET"
    ...
    def get_project(self, project_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/get_project.py.html>`__ to see an example of how to use get_project API.
        """
        resource_path = "/projects/{projectId}"
        method = "GET"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        resource_path = "/workRequests/{workRequestId}"
        method = "GET"
    ...
    def list_ai_private_endpoints(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_ai_private_endpoints.py.html>`__ to see an example of how to use list_ai_private_endpoints API.
        """
        resource_path = "/aiPrivateEndpoints"
        method = "GET"
    ...
    def list_data_assets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_data_assets.py.html>`__ to see an example of how to use list_data_assets API.
        """
        resource_path = "/dataAssets"
        method = "GET"
    ...
    def list_models(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_models.py.html>`__ to see an example of how to use list_models API.
        """
        resource_path = "/models"
        method = "GET"
    ...
    def list_projects(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_projects.py.html>`__ to see an example of how to use list_projects API.
        """
        resource_path = "/projects"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_ai_private_endpoint(self, ai_private_endpoint_id, update_ai_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/update_ai_private_endpoint.py.html>`__ to see an example of how to use update_ai_private_endpoint API.
        """
        resource_path = "/aiPrivateEndpoints/{aiPrivateEndpointId}"
        method = "PUT"
    ...
    def update_data_asset(self, data_asset_id, update_data_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/update_data_asset.py.html>`__ to see an example of how to use update_data_asset API.
        """
        resource_path = "/dataAssets/{dataAssetId}"
        method = "PUT"
    ...
    def update_model(self, model_id, update_model_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/update_model.py.html>`__ to see an example of how to use update_model API.
        """
        resource_path = "/models/{modelId}"
        method = "PUT"
    ...
    def update_project(self, project_id, update_project_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/aianomalydetection/update_project.py.html>`__ to see an example of how to use update_project API.
        """
        resource_path = "/projects/{projectId}"
        method = "PUT"

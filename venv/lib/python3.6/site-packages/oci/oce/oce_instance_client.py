...
class OceInstanceClient(object):
    ...
    def change_oce_instance_compartment(self, oce_instance_id, change_oce_instance_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/change_oce_instance_compartment.py.html>`__ to see an example of how to use change_oce_instance_compartment API.
        """
    ...
    def create_oce_instance(self, create_oce_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/create_oce_instance.py.html>`__ to see an example of how to use create_oce_instance API.
        """
    ...
    def delete_oce_instance(self, oce_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/delete_oce_instance.py.html>`__ to see an example of how to use delete_oce_instance API.
        """
    ...
    def get_oce_instance(self, oce_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/get_oce_instance.py.html>`__ to see an example of how to use get_oce_instance API.
        """
        resource_path = "/oceInstances/{oceInstanceId}"
        method = "GET"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_oce_instances(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/list_oce_instances.py.html>`__ to see an example of how to use list_oce_instances API.
        """
        resource_path = "/oceInstances"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_oce_instance(self, oce_instance_id, update_oce_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oce/update_oce_instance.py.html>`__ to see an example of how to use update_oce_instance API.
        """
        resource_path = "/oceInstances/{oceInstanceId}"
        method = "PUT"

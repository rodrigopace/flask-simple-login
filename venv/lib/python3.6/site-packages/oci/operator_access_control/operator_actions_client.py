...
class OperatorActionsClient(object):
    ...
    def get_operator_action(self, operator_action_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/get_operator_action.py.html>`__ to see an example of how to use get_operator_action API.
        """
    ...
    def list_operator_actions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/list_operator_actions.py.html>`__ to see an example of how to use list_operator_actions API.
        """

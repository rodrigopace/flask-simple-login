...
class OperatorControlAssignmentClient(object):
    ...
    def change_operator_control_assignment_compartment(self, operator_control_assignment_id, change_operator_control_assignment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/change_operator_control_assignment_compartment.py.html>`__ to see an example of how to use change_operator_control_assignment_compartment API.
        """
    ...
    def create_operator_control_assignment(self, create_operator_control_assignment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/create_operator_control_assignment.py.html>`__ to see an example of how to use create_operator_control_assignment API.
        """
    ...
    def delete_operator_control_assignment(self, operator_control_assignment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/delete_operator_control_assignment.py.html>`__ to see an example of how to use delete_operator_control_assignment API.
        """
    ...
    def get_operator_control_assignment(self, operator_control_assignment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/get_operator_control_assignment.py.html>`__ to see an example of how to use get_operator_control_assignment API.
        """
        resource_path = "/operatorControlAssignments/{operatorControlAssignmentId}"
        method = "GET"
    ...
    def list_operator_control_assignments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/list_operator_control_assignments.py.html>`__ to see an example of how to use list_operator_control_assignments API.
        """
        resource_path = "/operatorControlAssignments"
        method = "GET"
    ...
    def update_operator_control_assignment(self, operator_control_assignment_id, update_operator_control_assignment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/update_operator_control_assignment.py.html>`__ to see an example of how to use update_operator_control_assignment API.
        """
        resource_path = "/operatorControlAssignments/{operatorControlAssignmentId}"
        method = "PUT"

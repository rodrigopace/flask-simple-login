...
class OperatorControlClient(object):
    ...
    def change_operator_control_compartment(self, operator_control_id, change_operator_control_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/change_operator_control_compartment.py.html>`__ to see an example of how to use change_operator_control_compartment API.
        """
    ...
    def create_operator_control(self, create_operator_control_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/create_operator_control.py.html>`__ to see an example of how to use create_operator_control API.
        """
    ...
    def delete_operator_control(self, operator_control_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/delete_operator_control.py.html>`__ to see an example of how to use delete_operator_control API.
        """
    ...
    def get_operator_control(self, operator_control_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/get_operator_control.py.html>`__ to see an example of how to use get_operator_control API.
        """
        resource_path = "/operatorControls/{operatorControlId}"
        method = "GET"
    ...
    def list_operator_controls(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/list_operator_controls.py.html>`__ to see an example of how to use list_operator_controls API.
        """
        resource_path = "/operatorControls"
        method = "GET"
    ...
    def update_operator_control(self, operator_control_id, update_operator_control_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/operatoraccesscontrol/update_operator_control.py.html>`__ to see an example of how to use update_operator_control API.
        """
        resource_path = "/operatorControls/{operatorControlId}"
        method = "PUT"

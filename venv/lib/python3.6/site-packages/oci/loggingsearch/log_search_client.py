...
class LogSearchClient(object):
    ...
    def search_logs(self, search_logs_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/loggingsearch/search_logs.py.html>`__ to see an example of how to use search_logs API.
        """

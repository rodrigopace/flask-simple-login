    ...
    **Note:** Write actions (POST, UPDATE, DELETE) may take several minutes to propagate and be reflected by the API.
    ...
    def change_email_domain_compartment(self, email_domain_id, change_email_domain_compartment_details, **kwargs):
        ...
        **Note:** All Dkim objects associated with this email domain will also be moved into the provided compartment.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/change_email_domain_compartment.py.html>`__ to see an example of how to use change_email_domain_compartment API.
        """
    ...
    def change_sender_compartment(self, sender_id, change_sender_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/change_sender_compartment.py.html>`__ to see an example of how to use change_sender_compartment API.
        """
    ...
    def create_dkim(self, create_dkim_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/create_dkim.py.html>`__ to see an example of how to use create_dkim API.
        """
        resource_path = "/dkims"
        method = "POST"
    ...
    def create_email_domain(self, create_email_domain_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/create_email_domain.py.html>`__ to see an example of how to use create_email_domain API.
        """
    ...
    def create_sender(self, create_sender_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/create_sender.py.html>`__ to see an example of how to use create_sender API.
        """
    ...
    def create_suppression(self, create_suppression_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/create_suppression.py.html>`__ to see an example of how to use create_suppression API.
        """
    ...
    def delete_dkim(self, dkim_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/delete_dkim.py.html>`__ to see an example of how to use delete_dkim API.
        """
    ...
    def delete_email_domain(self, email_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/delete_email_domain.py.html>`__ to see an example of how to use delete_email_domain API.
        """
    ...
    def delete_sender(self, sender_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/delete_sender.py.html>`__ to see an example of how to use delete_sender API.
        """
    ...
    def delete_suppression(self, suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/delete_suppression.py.html>`__ to see an example of how to use delete_suppression API.
        """
    ...
    def get_dkim(self, dkim_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/get_dkim.py.html>`__ to see an example of how to use get_dkim API.
        """
        resource_path = "/dkims/{dkimId}"
        method = "GET"
    ...
    def get_email_domain(self, email_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/get_email_domain.py.html>`__ to see an example of how to use get_email_domain API.
        """
        resource_path = "/emailDomains/{emailDomainId}"
        method = "GET"
    ...
    def get_sender(self, sender_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/get_sender.py.html>`__ to see an example of how to use get_sender API.
        """
        resource_path = "/senders/{senderId}"
        method = "GET"
    ...
    def get_suppression(self, suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/get_suppression.py.html>`__ to see an example of how to use get_suppression API.
        """
        resource_path = "/suppressions/{suppressionId}"
        method = "GET"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_dkims(self, email_domain_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_dkims.py.html>`__ to see an example of how to use list_dkims API.
        """
        resource_path = "/dkims"
        method = "GET"
    ...
    def list_email_domains(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_email_domains.py.html>`__ to see an example of how to use list_email_domains API.
        """
        resource_path = "/emailDomains"
        method = "GET"
    ...
    def list_senders(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_senders.py.html>`__ to see an example of how to use list_senders API.
        """
        resource_path = "/senders"
        method = "GET"
    ...
    def list_suppressions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_suppressions.py.html>`__ to see an example of how to use list_suppressions API.
        """
        resource_path = "/suppressions"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_dkim(self, dkim_id, update_dkim_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/update_dkim.py.html>`__ to see an example of how to use update_dkim API.
        """
        resource_path = "/dkims/{dkimId}"
        method = "PUT"
    ...
    def update_email_domain(self, email_domain_id, update_email_domain_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/update_email_domain.py.html>`__ to see an example of how to use update_email_domain API.
        """
        resource_path = "/emailDomains/{emailDomainId}"
        method = "PUT"
    ...
    def update_sender(self, sender_id, update_sender_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/email/update_sender.py.html>`__ to see an example of how to use update_sender API.
        """
        resource_path = "/senders/{senderId}"
        method = "PUT"

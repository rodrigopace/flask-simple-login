...
class DiagnosabilityClient(object):
    ...
    def list_alert_logs(self, managed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/databasemanagement/list_alert_logs.py.html>`__ to see an example of how to use list_alert_logs API.
        """
    ...
    def list_attention_logs(self, managed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/databasemanagement/list_attention_logs.py.html>`__ to see an example of how to use list_attention_logs API.
        """
    ...
    def summarize_alert_log_counts(self, managed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/databasemanagement/summarize_alert_log_counts.py.html>`__ to see an example of how to use summarize_alert_log_counts API.
        """
    ...
    def summarize_attention_log_counts(self, managed_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/databasemanagement/summarize_attention_log_counts.py.html>`__ to see an example of how to use summarize_attention_log_counts API.
        """

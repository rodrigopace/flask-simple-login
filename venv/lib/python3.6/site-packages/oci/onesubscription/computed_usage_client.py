...
class ComputedUsageClient(object):
    ...
    def get_computed_usage(self, computed_usage_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/get_computed_usage.py.html>`__ to see an example of how to use get_computed_usage API.
        """
    ...
    def list_aggregated_computed_usages(self, compartment_id, subscription_id, time_from, time_to, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/list_aggregated_computed_usages.py.html>`__ to see an example of how to use list_aggregated_computed_usages API.
        """
    ...
    def list_computed_usages(self, compartment_id, subscription_id, time_from, time_to, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/list_computed_usages.py.html>`__ to see an example of how to use list_computed_usages API.
        """

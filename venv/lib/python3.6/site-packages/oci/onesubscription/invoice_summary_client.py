...
class InvoiceSummaryClient(object):
    ...
    def list_invoiceline_computed_usages(self, compartment_id, invoice_line_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/list_invoiceline_computed_usages.py.html>`__ to see an example of how to use list_invoiceline_computed_usages API.
        """
    ...
    def list_invoices(self, compartment_id, ar_customer_transaction_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/list_invoices.py.html>`__ to see an example of how to use list_invoices API.
        """

...
class RatecardClient(object):
    ...
    def list_rate_cards(self, subscription_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/list_rate_cards.py.html>`__ to see an example of how to use list_rate_cards API.
        """

...
class SubscribedServiceClient(object):
    ...
    def get_subscribed_service(self, subscribed_service_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/get_subscribed_service.py.html>`__ to see an example of how to use get_subscribed_service API.
        """
    ...
    def list_subscribed_services(self, compartment_id, subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/onesubscription/list_subscribed_services.py.html>`__ to see an example of how to use list_subscribed_services API.
        """

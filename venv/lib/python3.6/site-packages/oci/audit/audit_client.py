...
class AuditClient(object):
    ...
    **Tip**: This API is good for queries, but not bulk-export operations.
    ...
    def get_configuration(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/audit/get_configuration.py.html>`__ to see an example of how to use get_configuration API.
        """
    ...
    def list_events(self, compartment_id, start_time, end_time, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/audit/list_events.py.html>`__ to see an example of how to use list_events API.
        """
    ...
    def update_configuration(self, compartment_id, update_configuration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/audit/update_configuration.py.html>`__ to see an example of how to use update_configuration API.
        """
        resource_path = "/configuration"
        method = "PUT"

...
class ServiceManagerProxyClient(object):
    ...
    def get_service_environment(self, service_environment_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/servicemanagerproxy/get_service_environment.py.html>`__ to see an example of how to use get_service_environment API.
        """
    ...
    def list_service_environments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/servicemanagerproxy/list_service_environments.py.html>`__ to see an example of how to use list_service_environments API.
        """

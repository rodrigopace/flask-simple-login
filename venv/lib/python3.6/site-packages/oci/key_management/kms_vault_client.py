...
class KmsVaultClient(object):
    ...
    def backup_vault(self, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/backup_vault.py.html>`__ to see an example of how to use backup_vault API.
        """
    ...
    def cancel_vault_deletion(self, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/cancel_vault_deletion.py.html>`__ to see an example of how to use cancel_vault_deletion API.
        """
    ...
    def change_vault_compartment(self, vault_id, change_vault_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/change_vault_compartment.py.html>`__ to see an example of how to use change_vault_compartment API.
        """
    ...
    def create_vault(self, create_vault_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/create_vault.py.html>`__ to see an example of how to use create_vault API.
        """
    ...
    def create_vault_replica(self, vault_id, create_vault_replica_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/create_vault_replica.py.html>`__ to see an example of how to use create_vault_replica API.
        """
    ...
    def delete_vault_replica(self, vault_id, delete_vault_replica_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/delete_vault_replica.py.html>`__ to see an example of how to use delete_vault_replica API.
        """
    ...
    def get_vault(self, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/get_vault.py.html>`__ to see an example of how to use get_vault API.
        """
    ...
    def get_vault_usage(self, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/get_vault_usage.py.html>`__ to see an example of how to use get_vault_usage API.
        """
    ...
    def list_vault_replicas(self, vault_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/list_vault_replicas.py.html>`__ to see an example of how to use list_vault_replicas API.
        """
    ...
    def list_vaults(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/list_vaults.py.html>`__ to see an example of how to use list_vaults API.
        """
        resource_path = "/20180608/vaults"
        method = "GET"
    ...
    def restore_vault_from_file(self, compartment_id, restore_vault_from_file_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/restore_vault_from_file.py.html>`__ to see an example of how to use restore_vault_from_file API.
        """
    ...
    def restore_vault_from_object_store(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/restore_vault_from_object_store.py.html>`__ to see an example of how to use restore_vault_from_object_store API.
        """
    ...
    def schedule_vault_deletion(self, vault_id, schedule_vault_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/schedule_vault_deletion.py.html>`__ to see an example of how to use schedule_vault_deletion API.
        """
    ...
    def update_vault(self, vault_id, update_vault_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/update_vault.py.html>`__ to see an example of how to use update_vault API.
        """
        resource_path = "/20180608/vaults/{vaultId}"
        method = "PUT"

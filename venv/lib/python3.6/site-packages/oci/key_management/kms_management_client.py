...
class KmsManagementClient(object):
    ...
    def backup_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/backup_key.py.html>`__ to see an example of how to use backup_key API.
        """
    ...
    def cancel_key_deletion(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/cancel_key_deletion.py.html>`__ to see an example of how to use cancel_key_deletion API.
        """
    ...
    def cancel_key_version_deletion(self, key_id, key_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/cancel_key_version_deletion.py.html>`__ to see an example of how to use cancel_key_version_deletion API.
        """
    ...
    def change_key_compartment(self, key_id, change_key_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/change_key_compartment.py.html>`__ to see an example of how to use change_key_compartment API.
        """
    ...
    def create_key(self, create_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/create_key.py.html>`__ to see an example of how to use create_key API.
        """
    ...
    def create_key_version(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/create_key_version.py.html>`__ to see an example of how to use create_key_version API.
        """
    ...
    def disable_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/disable_key.py.html>`__ to see an example of how to use disable_key API.
        """
    ...
    def enable_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/enable_key.py.html>`__ to see an example of how to use enable_key API.
        """
    ...
    def get_key(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/get_key.py.html>`__ to see an example of how to use get_key API.
        """
    ...
    def get_key_version(self, key_id, key_version_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/get_key_version.py.html>`__ to see an example of how to use get_key_version API.
        """
    ...
    def get_replication_status(self, replication_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/get_replication_status.py.html>`__ to see an example of how to use get_replication_status API.
        """
    ...
    def get_wrapping_key(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/get_wrapping_key.py.html>`__ to see an example of how to use get_wrapping_key API.
        """
    ...
    def import_key(self, import_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/import_key.py.html>`__ to see an example of how to use import_key API.
        """
    ...
    def import_key_version(self, key_id, import_key_version_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/import_key_version.py.html>`__ to see an example of how to use import_key_version API.
        """
    ...
    def list_key_versions(self, key_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/list_key_versions.py.html>`__ to see an example of how to use list_key_versions API.
        """
        resource_path = "/20180608/keys/{keyId}/keyVersions"
        method = "GET"
    ...
    def list_keys(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/list_keys.py.html>`__ to see an example of how to use list_keys API.
        """
        resource_path = "/20180608/keys"
        method = "GET"
    ...
    def restore_key_from_file(self, restore_key_from_file_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/restore_key_from_file.py.html>`__ to see an example of how to use restore_key_from_file API.
        """
    ...
    def restore_key_from_object_store(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/restore_key_from_object_store.py.html>`__ to see an example of how to use restore_key_from_object_store API.
        """
    ...
    def schedule_key_deletion(self, key_id, schedule_key_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/schedule_key_deletion.py.html>`__ to see an example of how to use schedule_key_deletion API.
        """
    ...
    def schedule_key_version_deletion(self, key_id, key_version_id, schedule_key_version_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/schedule_key_version_deletion.py.html>`__ to see an example of how to use schedule_key_version_deletion API.
        """
    ...
    def update_key(self, key_id, update_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/keymanagement/update_key.py.html>`__ to see an example of how to use update_key API.
        """
        resource_path = "/20180608/keys/{keyId}"
        method = "PUT"

...
class BudgetClient(object):
    ...
    def create_alert_rule(self, budget_id, create_alert_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/create_alert_rule.py.html>`__ to see an example of how to use create_alert_rule API.
        """
    ...
    def create_budget(self, create_budget_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/create_budget.py.html>`__ to see an example of how to use create_budget API.
        """
    ...
    def delete_alert_rule(self, budget_id, alert_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/delete_alert_rule.py.html>`__ to see an example of how to use delete_alert_rule API.
        """
    ...
    def delete_budget(self, budget_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/delete_budget.py.html>`__ to see an example of how to use delete_budget API.
        """
    ...
    def get_alert_rule(self, budget_id, alert_rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/get_alert_rule.py.html>`__ to see an example of how to use get_alert_rule API.
        """
        resource_path = "/budgets/{budgetId}/alertRules/{alertRuleId}"
        method = "GET"
    ...
    def get_budget(self, budget_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/get_budget.py.html>`__ to see an example of how to use get_budget API.
        """
        resource_path = "/budgets/{budgetId}"
        method = "GET"
    ...
    def list_alert_rules(self, budget_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/list_alert_rules.py.html>`__ to see an example of how to use list_alert_rules API.
        """
        resource_path = "/budgets/{budgetId}/alertRules"
        method = "GET"
    ...
    def list_budgets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/list_budgets.py.html>`__ to see an example of how to use list_budgets API.
        """
        resource_path = "/budgets"
        method = "GET"
    ...
    def update_alert_rule(self, budget_id, alert_rule_id, update_alert_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/update_alert_rule.py.html>`__ to see an example of how to use update_alert_rule API.
        """
        resource_path = "/budgets/{budgetId}/alertRules/{alertRuleId}"
        method = "PUT"
    ...
    def update_budget(self, budget_id, update_budget_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/budget/update_budget.py.html>`__ to see an example of how to use update_budget API.
        """
        resource_path = "/budgets/{budgetId}"
        method = "PUT"

...
class EventsClient(object):
    ...
    def change_rule_compartment(self, rule_id, change_rule_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/events/change_rule_compartment.py.html>`__ to see an example of how to use change_rule_compartment API.
        """
    ...
    def create_rule(self, create_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/events/create_rule.py.html>`__ to see an example of how to use create_rule API.
        """
        resource_path = "/rules"
        method = "POST"
    ...
    def delete_rule(self, rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/events/delete_rule.py.html>`__ to see an example of how to use delete_rule API.
        """
    ...
    def get_rule(self, rule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/events/get_rule.py.html>`__ to see an example of how to use get_rule API.
        """
        resource_path = "/rules/{ruleId}"
        method = "GET"
    ...
    def list_rules(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/events/list_rules.py.html>`__ to see an example of how to use list_rules API.
        """
        resource_path = "/rules"
        method = "GET"
    ...
    def update_rule(self, rule_id, update_rule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/events/update_rule.py.html>`__ to see an example of how to use update_rule API.
        """
        resource_path = "/rules/{ruleId}"
        method = "PUT"

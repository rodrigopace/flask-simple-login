...
class NetworkValidationClient(object):
    ...
    def get_network_connectivity_status_collection(self, registry_id, endpoint_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataconnectivity/get_network_connectivity_status_collection.py.html>`__ to see an example of how to use get_network_connectivity_status_collection API.
        """

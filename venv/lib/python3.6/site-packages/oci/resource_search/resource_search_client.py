...
class ResourceSearchClient(object):
    ...
    def get_resource_type(self, name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/resourcesearch/get_resource_type.py.html>`__ to see an example of how to use get_resource_type API.
        """
    ...
    def list_resource_types(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/resourcesearch/list_resource_types.py.html>`__ to see an example of how to use list_resource_types API.
        """
    ...
    def search_resources(self, search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/resourcesearch/search_resources.py.html>`__ to see an example of how to use search_resources API.
        """

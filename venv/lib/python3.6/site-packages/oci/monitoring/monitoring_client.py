...
class MonitoringClient(object):
    ...
    def change_alarm_compartment(self, alarm_id, change_alarm_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/change_alarm_compartment.py.html>`__ to see an example of how to use change_alarm_compartment API.
        """
    ...
    def create_alarm(self, create_alarm_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/create_alarm.py.html>`__ to see an example of how to use create_alarm API.
        """
    ...
    def delete_alarm(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/delete_alarm.py.html>`__ to see an example of how to use delete_alarm API.
        """
    ...
    def get_alarm(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/get_alarm.py.html>`__ to see an example of how to use get_alarm API.
        """
        resource_path = "/alarms/{alarmId}"
        method = "GET"
    ...
    def get_alarm_history(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/get_alarm_history.py.html>`__ to see an example of how to use get_alarm_history API.
        """
    ...
    def list_alarms(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/list_alarms.py.html>`__ to see an example of how to use list_alarms API.
        """
        resource_path = "/alarms"
        method = "GET"
    ...
    def list_alarms_status(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/list_alarms_status.py.html>`__ to see an example of how to use list_alarms_status API.
        """
    ...
    def list_metrics(self, compartment_id, list_metrics_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/list_metrics.py.html>`__ to see an example of how to use list_metrics API.
        """
    ...
    def post_metric_data(self, post_metric_data_details, **kwargs):
        ...
        *A metric group is the combination of a given metric, metric namespace, and tenancy for the purpose of determining limits.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/post_metric_data.py.html>`__ to see an example of how to use post_metric_data API.
        """
    ...
    def remove_alarm_suppression(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/remove_alarm_suppression.py.html>`__ to see an example of how to use remove_alarm_suppression API.
        """
    ...
    def retrieve_dimension_states(self, alarm_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/retrieve_dimension_states.py.html>`__ to see an example of how to use retrieve_dimension_states API.
        """
    ...
    def summarize_metrics_data(self, compartment_id, summarize_metrics_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/summarize_metrics_data.py.html>`__ to see an example of how to use summarize_metrics_data API.
        """
    ...
    def update_alarm(self, alarm_id, update_alarm_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/monitoring/update_alarm.py.html>`__ to see an example of how to use update_alarm API.
        """
        resource_path = "/alarms/{alarmId}"
        method = "PUT"

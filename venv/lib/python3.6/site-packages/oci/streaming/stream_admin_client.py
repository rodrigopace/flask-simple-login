...
class StreamAdminClient(object):
    ...
    def change_connect_harness_compartment(self, connect_harness_id, change_connect_harness_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/change_connect_harness_compartment.py.html>`__ to see an example of how to use change_connect_harness_compartment API.
        """
    ...
    def change_stream_compartment(self, stream_id, change_stream_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/change_stream_compartment.py.html>`__ to see an example of how to use change_stream_compartment API.
        """
    ...
    def change_stream_pool_compartment(self, stream_pool_id, change_stream_pool_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/change_stream_pool_compartment.py.html>`__ to see an example of how to use change_stream_pool_compartment API.
        """
    ...
    def create_connect_harness(self, create_connect_harness_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/create_connect_harness.py.html>`__ to see an example of how to use create_connect_harness API.
        """
    ...
    def create_stream(self, create_stream_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/create_stream.py.html>`__ to see an example of how to use create_stream API.
        """
    ...
    def create_stream_pool(self, create_stream_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/create_stream_pool.py.html>`__ to see an example of how to use create_stream_pool API.
        """
    ...
    def delete_connect_harness(self, connect_harness_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/delete_connect_harness.py.html>`__ to see an example of how to use delete_connect_harness API.
        """
    ...
    def delete_stream(self, stream_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/delete_stream.py.html>`__ to see an example of how to use delete_stream API.
        """
    ...
    def delete_stream_pool(self, stream_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/delete_stream_pool.py.html>`__ to see an example of how to use delete_stream_pool API.
        """
    ...
    def get_connect_harness(self, connect_harness_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/get_connect_harness.py.html>`__ to see an example of how to use get_connect_harness API.
        """
        resource_path = "/connectharnesses/{connectHarnessId}"
        method = "GET"
    ...
    def get_stream(self, stream_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/get_stream.py.html>`__ to see an example of how to use get_stream API.
        """
        resource_path = "/streams/{streamId}"
        method = "GET"
    ...
    def get_stream_pool(self, stream_pool_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/get_stream_pool.py.html>`__ to see an example of how to use get_stream_pool API.
        """
        resource_path = "/streampools/{streamPoolId}"
        method = "GET"
    ...
    def list_connect_harnesses(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/list_connect_harnesses.py.html>`__ to see an example of how to use list_connect_harnesses API.
        """
        resource_path = "/connectharnesses"
        method = "GET"
    ...
    def list_stream_pools(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/list_stream_pools.py.html>`__ to see an example of how to use list_stream_pools API.
        """
        resource_path = "/streampools"
        method = "GET"
    ...
    def list_streams(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/list_streams.py.html>`__ to see an example of how to use list_streams API.
        """
        resource_path = "/streams"
        method = "GET"
    ...
    def update_connect_harness(self, connect_harness_id, update_connect_harness_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/update_connect_harness.py.html>`__ to see an example of how to use update_connect_harness API.
        """
        resource_path = "/connectharnesses/{connectHarnessId}"
        method = "PUT"
    ...
    def update_stream(self, stream_id, update_stream_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/update_stream.py.html>`__ to see an example of how to use update_stream API.
        """
        resource_path = "/streams/{streamId}"
        method = "PUT"
    ...
    def update_stream_pool(self, stream_pool_id, update_stream_pool_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/update_stream_pool.py.html>`__ to see an example of how to use update_stream_pool API.
        """
        resource_path = "/streampools/{streamPoolId}"
        method = "PUT"

...
class StreamClient(object):
    ...
    def consumer_commit(self, stream_id, cursor, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/consumer_commit.py.html>`__ to see an example of how to use consumer_commit API.
        """
    ...
    def consumer_heartbeat(self, stream_id, cursor, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/consumer_heartbeat.py.html>`__ to see an example of how to use consumer_heartbeat API.
        """
    ...
    def create_cursor(self, stream_id, create_cursor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/create_cursor.py.html>`__ to see an example of how to use create_cursor API.
        """
    ...
    def create_group_cursor(self, stream_id, create_group_cursor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/create_group_cursor.py.html>`__ to see an example of how to use create_group_cursor API.
        """
    ...
    def get_group(self, stream_id, group_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/get_group.py.html>`__ to see an example of how to use get_group API.
        """
    ...
    def get_messages(self, stream_id, cursor, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/get_messages.py.html>`__ to see an example of how to use get_messages API.
        """
    ...
    def put_messages(self, stream_id, put_messages_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/put_messages.py.html>`__ to see an example of how to use put_messages API.
        """
        resource_path = "/streams/{streamId}/messages"
        method = "POST"
    ...
    def update_group(self, stream_id, group_name, update_group_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/streaming/update_group.py.html>`__ to see an example of how to use update_group API.
        """
        resource_path = "/streams/{streamId}/groups/{groupName}"
        method = "PUT"

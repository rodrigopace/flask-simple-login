...
class EventClient(object):
    ...
    def delete_event_content(self, managed_instance_id, event_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/delete_event_content.py.html>`__ to see an example of how to use delete_event_content API.
        """
    ...
    def get_event(self, managed_instance_id, event_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/get_event.py.html>`__ to see an example of how to use get_event API.
        """
    ...
    def get_event_content(self, managed_instance_id, event_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/get_event_content.py.html>`__ to see an example of how to use get_event_content API.
        """
        resource_path = "/managedInstances/{managedInstanceId}/events/{eventId}/content"
        method = "GET"
    ...
    def get_event_report(self, managed_instance_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/get_event_report.py.html>`__ to see an example of how to use get_event_report API.
        """
    ...
    def list_events(self, managed_instance_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/list_events.py.html>`__ to see an example of how to use list_events API.
        """
    ...
    def list_related_events(self, event_fingerprint, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/list_related_events.py.html>`__ to see an example of how to use list_related_events API.
        """
    ...
    def update_event(self, managed_instance_id, event_id, compartment_id, update_event_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/update_event.py.html>`__ to see an example of how to use update_event API.
        """
        resource_path = "/managedInstances/{managedInstanceId}/events/{eventId}"
        method = "PUT"
    ...
    def upload_event_content(self, managed_instance_id, event_id, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/osmanagement/upload_event_content.py.html>`__ to see an example of how to use upload_event_content API.
        """

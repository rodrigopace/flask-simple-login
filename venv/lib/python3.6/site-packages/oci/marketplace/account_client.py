...
class AccountClient(object):
    ...
    def get_launch_eligibility(self, compartment_id, image_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/marketplace/get_launch_eligibility.py.html>`__ to see an example of how to use get_launch_eligibility API.
        """
    ...
    def get_third_party_paid_listing_eligibility(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/marketplace/get_third_party_paid_listing_eligibility.py.html>`__ to see an example of how to use get_third_party_paid_listing_eligibility API.
        """

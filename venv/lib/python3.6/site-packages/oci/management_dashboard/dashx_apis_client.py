...
class DashxApisClient(object):
    ...
    def change_management_dashboards_compartment(self, management_dashboard_id, change_management_dashboards_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/change_management_dashboards_compartment.py.html>`__ to see an example of how to use change_management_dashboards_compartment API.
        """
    ...
    def change_management_saved_searches_compartment(self, management_saved_search_id, change_management_saved_searches_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/change_management_saved_searches_compartment.py.html>`__ to see an example of how to use change_management_saved_searches_compartment API.
        """
    ...
    def create_management_dashboard(self, create_management_dashboard_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/create_management_dashboard.py.html>`__ to see an example of how to use create_management_dashboard API.
        """
    ...
    def create_management_saved_search(self, create_management_saved_search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/create_management_saved_search.py.html>`__ to see an example of how to use create_management_saved_search API.
        """
    ...
    def delete_management_dashboard(self, management_dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/delete_management_dashboard.py.html>`__ to see an example of how to use delete_management_dashboard API.
        """
    ...
    def delete_management_saved_search(self, management_saved_search_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/delete_management_saved_search.py.html>`__ to see an example of how to use delete_management_saved_search API.
        """
    ...
    def export_dashboard(self, export_dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/export_dashboard.py.html>`__ to see an example of how to use export_dashboard API.
        """
    ...
    def get_management_dashboard(self, management_dashboard_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/get_management_dashboard.py.html>`__ to see an example of how to use get_management_dashboard API.
        """
        resource_path = "/managementDashboards/{managementDashboardId}"
        method = "GET"
    ...
    def get_management_saved_search(self, management_saved_search_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/get_management_saved_search.py.html>`__ to see an example of how to use get_management_saved_search API.
        """
        resource_path = "/managementSavedSearches/{managementSavedSearchId}"
        method = "GET"
    ...
    def import_dashboard(self, management_dashboard_import_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/import_dashboard.py.html>`__ to see an example of how to use import_dashboard API.
        """
    ...
    def list_management_dashboards(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/list_management_dashboards.py.html>`__ to see an example of how to use list_management_dashboards API.
        """
        resource_path = "/managementDashboards"
        method = "GET"
    ...
    def list_management_saved_searches(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/list_management_saved_searches.py.html>`__ to see an example of how to use list_management_saved_searches API.
        """
        resource_path = "/managementSavedSearches"
        method = "GET"
    ...
    def update_management_dashboard(self, management_dashboard_id, update_management_dashboard_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/update_management_dashboard.py.html>`__ to see an example of how to use update_management_dashboard API.
        """
        resource_path = "/managementDashboards/{managementDashboardId}"
        method = "PUT"
    ...
    def update_management_saved_search(self, management_saved_search_id, update_management_saved_search_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/managementdashboard/update_management_saved_search.py.html>`__ to see an example of how to use update_management_saved_search API.
        """
        resource_path = "/managementSavedSearches/{managementSavedSearchId}"
        method = "PUT"

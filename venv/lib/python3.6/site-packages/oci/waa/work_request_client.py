...
class WorkRequestClient(object):
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """

...
class WaaClient(object):
    ...
    def change_web_app_acceleration_compartment(self, web_app_acceleration_id, change_web_app_acceleration_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/change_web_app_acceleration_compartment.py.html>`__ to see an example of how to use change_web_app_acceleration_compartment API.
        """
    ...
    def change_web_app_acceleration_policy_compartment(self, web_app_acceleration_policy_id, change_web_app_acceleration_policy_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/change_web_app_acceleration_policy_compartment.py.html>`__ to see an example of how to use change_web_app_acceleration_policy_compartment API.
        """
    ...
    def create_web_app_acceleration(self, create_web_app_acceleration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/create_web_app_acceleration.py.html>`__ to see an example of how to use create_web_app_acceleration API.
        """
    ...
    def create_web_app_acceleration_policy(self, create_web_app_acceleration_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/create_web_app_acceleration_policy.py.html>`__ to see an example of how to use create_web_app_acceleration_policy API.
        """
    ...
    def delete_web_app_acceleration(self, web_app_acceleration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/delete_web_app_acceleration.py.html>`__ to see an example of how to use delete_web_app_acceleration API.
        """
    ...
    def delete_web_app_acceleration_policy(self, web_app_acceleration_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/delete_web_app_acceleration_policy.py.html>`__ to see an example of how to use delete_web_app_acceleration_policy API.
        """
    ...
    def get_web_app_acceleration(self, web_app_acceleration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/get_web_app_acceleration.py.html>`__ to see an example of how to use get_web_app_acceleration API.
        """
        resource_path = "/webAppAccelerations/{webAppAccelerationId}"
        method = "GET"
    ...
    def get_web_app_acceleration_policy(self, web_app_acceleration_policy_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/get_web_app_acceleration_policy.py.html>`__ to see an example of how to use get_web_app_acceleration_policy API.
        """
        resource_path = "/webAppAccelerationPolicies/{webAppAccelerationPolicyId}"
        method = "GET"
    ...
    def list_web_app_acceleration_policies(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/list_web_app_acceleration_policies.py.html>`__ to see an example of how to use list_web_app_acceleration_policies API.
        """
        resource_path = "/webAppAccelerationPolicies"
        method = "GET"
    ...
    def list_web_app_accelerations(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/list_web_app_accelerations.py.html>`__ to see an example of how to use list_web_app_accelerations API.
        """
        resource_path = "/webAppAccelerations"
        method = "GET"
    ...
    def purge_web_app_acceleration_cache(self, web_app_acceleration_id, purge_web_app_acceleration_cache_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/purge_web_app_acceleration_cache.py.html>`__ to see an example of how to use purge_web_app_acceleration_cache API.
        """
    ...
    def update_web_app_acceleration(self, web_app_acceleration_id, update_web_app_acceleration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/update_web_app_acceleration.py.html>`__ to see an example of how to use update_web_app_acceleration API.
        """
        resource_path = "/webAppAccelerations/{webAppAccelerationId}"
        method = "PUT"
    ...
    def update_web_app_acceleration_policy(self, web_app_acceleration_policy_id, update_web_app_acceleration_policy_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/waa/update_web_app_acceleration_policy.py.html>`__ to see an example of how to use update_web_app_acceleration_policy API.
        """
        resource_path = "/webAppAccelerationPolicies/{webAppAccelerationPolicyId}"
        method = "PUT"

...
class DataFlowClient(object):
    ...
    def change_application_compartment(self, application_id, change_application_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/change_application_compartment.py.html>`__ to see an example of how to use change_application_compartment API.
        """
    ...
    def change_private_endpoint_compartment(self, private_endpoint_id, change_private_endpoint_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/change_private_endpoint_compartment.py.html>`__ to see an example of how to use change_private_endpoint_compartment API.
        """
    ...
    def change_run_compartment(self, run_id, change_run_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/change_run_compartment.py.html>`__ to see an example of how to use change_run_compartment API.
        """
    ...
    def create_application(self, create_application_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/create_application.py.html>`__ to see an example of how to use create_application API.
        """
    ...
    def create_private_endpoint(self, create_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/create_private_endpoint.py.html>`__ to see an example of how to use create_private_endpoint API.
        """
    ...
    def create_run(self, create_run_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/create_run.py.html>`__ to see an example of how to use create_run API.
        """
        resource_path = "/runs"
        method = "POST"
    ...
    def delete_application(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/delete_application.py.html>`__ to see an example of how to use delete_application API.
        """
    ...
    def delete_private_endpoint(self, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/delete_private_endpoint.py.html>`__ to see an example of how to use delete_private_endpoint API.
        """
    ...
    def delete_run(self, run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/delete_run.py.html>`__ to see an example of how to use delete_run API.
        """
    ...
    def get_application(self, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/get_application.py.html>`__ to see an example of how to use get_application API.
        """
        resource_path = "/applications/{applicationId}"
        method = "GET"
    ...
    def get_private_endpoint(self, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/get_private_endpoint.py.html>`__ to see an example of how to use get_private_endpoint API.
        """
        resource_path = "/privateEndpoints/{privateEndpointId}"
        method = "GET"
    ...
    def get_run(self, run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/get_run.py.html>`__ to see an example of how to use get_run API.
        """
        resource_path = "/runs/{runId}"
        method = "GET"
    ...
    def get_run_log(self, run_id, name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/get_run_log.py.html>`__ to see an example of how to use get_run_log API.
        """
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_applications(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_applications.py.html>`__ to see an example of how to use list_applications API.
        """
        resource_path = "/applications"
        method = "GET"
    ...
    def list_private_endpoints(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_private_endpoints.py.html>`__ to see an example of how to use list_private_endpoints API.
        """
        resource_path = "/privateEndpoints"
        method = "GET"
    ...
    def list_run_logs(self, run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_run_logs.py.html>`__ to see an example of how to use list_run_logs API.
        """
    ...
    def list_runs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_runs.py.html>`__ to see an example of how to use list_runs API.
        """
        resource_path = "/runs"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def update_application(self, update_application_details, application_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/update_application.py.html>`__ to see an example of how to use update_application API.
        """
        resource_path = "/applications/{applicationId}"
        method = "PUT"
    ...
    def update_private_endpoint(self, update_private_endpoint_details, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/update_private_endpoint.py.html>`__ to see an example of how to use update_private_endpoint API.
        """
        resource_path = "/privateEndpoints/{privateEndpointId}"
        method = "PUT"
    ...
    def update_run(self, update_run_details, run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/dataflow/update_run.py.html>`__ to see an example of how to use update_run API.
        """
        resource_path = "/runs/{runId}"
        method = "PUT"

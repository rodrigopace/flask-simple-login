...
class OdapackageClient(object):
    ...
    def create_imported_package(self, create_imported_package_details, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/create_imported_package.py.html>`__ to see an example of how to use create_imported_package API.
        """
    ...
    def delete_imported_package(self, oda_instance_id, package_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/delete_imported_package.py.html>`__ to see an example of how to use delete_imported_package API.
        """
    ...
    def get_imported_package(self, oda_instance_id, package_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/get_imported_package.py.html>`__ to see an example of how to use get_imported_package API.
        """
        resource_path = "/odaInstances/{odaInstanceId}/importedPackages/{packageId}"
        method = "GET"
    ...
    def get_package(self, oda_instance_id, package_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/get_package.py.html>`__ to see an example of how to use get_package API.
        """
    ...
    def list_imported_packages(self, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_imported_packages.py.html>`__ to see an example of how to use list_imported_packages API.
        """
        resource_path = "/odaInstances/{odaInstanceId}/importedPackages"
        method = "GET"
    ...
    def list_packages(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_packages.py.html>`__ to see an example of how to use list_packages API.
        """
    ...
    def update_imported_package(self, update_imported_package_details, oda_instance_id, package_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/update_imported_package.py.html>`__ to see an example of how to use update_imported_package API.
        """
        resource_path = "/odaInstances/{odaInstanceId}/importedPackages/{packageId}"
        method = "PUT"

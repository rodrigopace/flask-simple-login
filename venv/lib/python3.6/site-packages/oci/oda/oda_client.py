...
class OdaClient(object):
    ...
    def change_oda_instance_compartment(self, oda_instance_id, change_oda_instance_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/change_oda_instance_compartment.py.html>`__ to see an example of how to use change_oda_instance_compartment API.
        """
    ...
    def create_oda_instance(self, create_oda_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/create_oda_instance.py.html>`__ to see an example of how to use create_oda_instance API.
        """
    ...
    def create_oda_instance_attachment(self, oda_instance_id, create_oda_instance_attachment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/create_oda_instance_attachment.py.html>`__ to see an example of how to use create_oda_instance_attachment API.
        """
    ...
    def delete_oda_instance(self, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/delete_oda_instance.py.html>`__ to see an example of how to use delete_oda_instance API.
        """
    ...
    def delete_oda_instance_attachment(self, oda_instance_id, attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/delete_oda_instance_attachment.py.html>`__ to see an example of how to use delete_oda_instance_attachment API.
        """
    ...
    def get_oda_instance(self, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/get_oda_instance.py.html>`__ to see an example of how to use get_oda_instance API.
        """
        resource_path = "/odaInstances/{odaInstanceId}"
        method = "GET"
    ...
    def get_oda_instance_attachment(self, oda_instance_id, attachment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/get_oda_instance_attachment.py.html>`__ to see an example of how to use get_oda_instance_attachment API.
        """
        resource_path = "/odaInstances/{odaInstanceId}/attachments/{attachmentId}"
        method = "GET"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
    ...
    def list_oda_instance_attachments(self, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_oda_instance_attachments.py.html>`__ to see an example of how to use list_oda_instance_attachments API.
        """
        resource_path = "/odaInstances/{odaInstanceId}/attachments"
        method = "GET"
    ...
    def list_oda_instances(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_oda_instances.py.html>`__ to see an example of how to use list_oda_instances API.
        """
        resource_path = "/odaInstances"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def start_oda_instance(self, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/start_oda_instance.py.html>`__ to see an example of how to use start_oda_instance API.
        """
    ...
    def stop_oda_instance(self, oda_instance_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/stop_oda_instance.py.html>`__ to see an example of how to use stop_oda_instance API.
        """
    ...
    def update_oda_instance(self, oda_instance_id, update_oda_instance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/update_oda_instance.py.html>`__ to see an example of how to use update_oda_instance API.
        """
        resource_path = "/odaInstances/{odaInstanceId}"
        method = "PUT"
    ...
    def update_oda_instance_attachment(self, oda_instance_id, attachment_id, update_oda_instance_attachment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/oda/update_oda_instance_attachment.py.html>`__ to see an example of how to use update_oda_instance_attachment API.
        """
        resource_path = "/odaInstances/{odaInstanceId}/attachments/{attachmentId}"
        method = "PUT"

...
class TraceClient(object):
    ...
    def get_aggregated_snapshot(self, apm_domain_id, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmtraces/get_aggregated_snapshot.py.html>`__ to see an example of how to use get_aggregated_snapshot API.
        """
    ...
    def get_span(self, apm_domain_id, span_key, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmtraces/get_span.py.html>`__ to see an example of how to use get_span API.
        """
    ...
    def get_trace(self, apm_domain_id, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmtraces/get_trace.py.html>`__ to see an example of how to use get_trace API.
        """
    ...
    def get_trace_snapshot(self, apm_domain_id, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/apmtraces/get_trace_snapshot.py.html>`__ to see an example of how to use get_trace_snapshot API.
        """

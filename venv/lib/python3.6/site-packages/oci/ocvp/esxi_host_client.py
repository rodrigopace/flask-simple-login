...
class EsxiHostClient(object):
    ...
    def create_esxi_host(self, create_esxi_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/create_esxi_host.py.html>`__ to see an example of how to use create_esxi_host API.
        """
    ...
    def delete_esxi_host(self, esxi_host_id, **kwargs):
        ...
        **Note:** If you delete EXSi hosts from the SDDC to total less than 3,
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/delete_esxi_host.py.html>`__ to see an example of how to use delete_esxi_host API.
        """
    ...
    def get_esxi_host(self, esxi_host_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/get_esxi_host.py.html>`__ to see an example of how to use get_esxi_host API.
        """
        resource_path = "/esxiHosts/{esxiHostId}"
        method = "GET"
    ...
    def list_esxi_hosts(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/list_esxi_hosts.py.html>`__ to see an example of how to use list_esxi_hosts API.
        """
        resource_path = "/esxiHosts"
        method = "GET"
    ...
    def update_esxi_host(self, esxi_host_id, update_esxi_host_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/update_esxi_host.py.html>`__ to see an example of how to use update_esxi_host API.
        """
        resource_path = "/esxiHosts/{esxiHostId}"
        method = "PUT"

...
class SddcClient(object):
    ...
    def cancel_downgrade_hcx(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/cancel_downgrade_hcx.py.html>`__ to see an example of how to use cancel_downgrade_hcx API.
        """
    ...
    def change_sddc_compartment(self, sddc_id, change_sddc_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/change_sddc_compartment.py.html>`__ to see an example of how to use change_sddc_compartment API.
        """
    ...
    def create_sddc(self, create_sddc_details, **kwargs):
        ...
        **Important:** You must configure the SDDC's networking resources with the security rules detailed in `Security Rules for Oracle Cloud VMware Solution SDDCs`__. Otherwise, provisioning the SDDC will fail. The rules are based on the requirements set by VMware.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/create_sddc.py.html>`__ to see an example of how to use create_sddc API.
        """
        resource_path = "/sddcs"
        method = "POST"
    ...
    def delete_sddc(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/delete_sddc.py.html>`__ to see an example of how to use delete_sddc API.
        """
    ...
    def downgrade_hcx(self, downgrade_hcx_details, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/downgrade_hcx.py.html>`__ to see an example of how to use downgrade_hcx API.
        """
    ...
    def get_sddc(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/get_sddc.py.html>`__ to see an example of how to use get_sddc API.
        """
        resource_path = "/sddcs/{sddcId}"
        method = "GET"
    ...
    def list_sddcs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/list_sddcs.py.html>`__ to see an example of how to use list_sddcs API.
        """
        resource_path = "/sddcs"
        method = "GET"
    ...
    def list_supported_host_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/list_supported_host_shapes.py.html>`__ to see an example of how to use list_supported_host_shapes API.
        """
    ...
    def list_supported_skus(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/list_supported_skus.py.html>`__ to see an example of how to use list_supported_skus API.
        """
    ...
    def list_supported_vmware_software_versions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/list_supported_vmware_software_versions.py.html>`__ to see an example of how to use list_supported_vmware_software_versions API.
        """
    ...
    def refresh_hcx_license_status(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/refresh_hcx_license_status.py.html>`__ to see an example of how to use refresh_hcx_license_status API.
        """
    ...
    def update_sddc(self, sddc_id, update_sddc_details, **kwargs):
        ...
        **Important:** Updating an SDDC affects only certain attributes in the `Sddc`
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/update_sddc.py.html>`__ to see an example of how to use update_sddc API.
        """
        resource_path = "/sddcs/{sddcId}"
        method = "PUT"
    ...
    def upgrade_hcx(self, sddc_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/ocvp/upgrade_hcx.py.html>`__ to see an example of how to use upgrade_hcx API.
        """

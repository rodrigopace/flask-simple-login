...
class LoggingClient(object):
    ...
    def put_logs(self, log_id, put_logs_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/loggingingestion/put_logs.py.html>`__ to see an example of how to use put_logs API.
        """

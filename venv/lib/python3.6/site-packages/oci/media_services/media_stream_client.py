...
class MediaStreamClient(object):
    ...
    def generate_playlist(self, stream_packaging_config_id, media_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mediaservices/generate_playlist.py.html>`__ to see an example of how to use generate_playlist API.
        """
    ...
    def generate_session_token(self, generate_session_token_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/mediaservices/generate_session_token.py.html>`__ to see an example of how to use generate_session_token API.
        """

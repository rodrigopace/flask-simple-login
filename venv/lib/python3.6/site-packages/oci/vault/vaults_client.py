...
class VaultsClient(object):
    ...
    def cancel_secret_deletion(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/cancel_secret_deletion.py.html>`__ to see an example of how to use cancel_secret_deletion API.
        """
    ...
    def cancel_secret_version_deletion(self, secret_id, secret_version_number, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/cancel_secret_version_deletion.py.html>`__ to see an example of how to use cancel_secret_version_deletion API.
        """
    ...
    def change_secret_compartment(self, secret_id, change_secret_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/change_secret_compartment.py.html>`__ to see an example of how to use change_secret_compartment API.
        """
    ...
    def create_secret(self, create_secret_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/create_secret.py.html>`__ to see an example of how to use create_secret API.
        """
    ...
    def get_secret(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/get_secret.py.html>`__ to see an example of how to use get_secret API.
        """
    ...
    def get_secret_version(self, secret_id, secret_version_number, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/get_secret_version.py.html>`__ to see an example of how to use get_secret_version API.
        """
    ...
    def list_secret_versions(self, secret_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/list_secret_versions.py.html>`__ to see an example of how to use list_secret_versions API.
        """
    ...
    def list_secrets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/list_secrets.py.html>`__ to see an example of how to use list_secrets API.
        """
        resource_path = "/secrets"
        method = "GET"
    ...
    def schedule_secret_deletion(self, secret_id, schedule_secret_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/schedule_secret_deletion.py.html>`__ to see an example of how to use schedule_secret_deletion API.
        """
    ...
    def schedule_secret_version_deletion(self, secret_id, secret_version_number, schedule_secret_version_deletion_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/schedule_secret_version_deletion.py.html>`__ to see an example of how to use schedule_secret_version_deletion API.
        """
    ...
    def update_secret(self, secret_id, update_secret_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.82.0/vault/update_secret.py.html>`__ to see an example of how to use update_secret API.
        """
        resource_path = "/secrets/{secretId}"
        method = "PUT"
